...
impl WebhookStatusCommitCommit {
    pub fn new(
        author: models::WebhookStatusCommitCommitAuthor,
        comment_count: i32,
        committer: models::WebhookStatusCommitCommitAuthor,
        message: String,
        tree: models::ShortBranchCommit,
        url: String,
        verification: models::WebhookStatusCommitCommitVerification,
