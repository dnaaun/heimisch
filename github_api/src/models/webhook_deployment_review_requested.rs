...
impl WebhookDeploymentReviewRequested {
    pub fn new(
        ...
        requestor: Option<models::WebhooksUser>,
        reviewers: Vec<models::WebhookDeploymentReviewRequestedReviewersInner>,
        sender: models::SimpleUser,
        since: String,
        workflow_job_run: models::WebhookDeploymentReviewRequestedWorkflowJobRun,
        workflow_run: Option<models::DeploymentWorkflowRun3>,
        ...
        WebhookDeploymentReviewRequested {
            ...
            requestor: if let Some(x) = requestor {
                Some(Box::new(x))
            } else {
                None
            },
            ...
            workflow_run: if let Some(x) = workflow_run {
                Some(Box::new(x))
            } else {
                None
            },
