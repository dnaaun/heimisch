...
impl RepositoryAdvisory {
    ...
    pub fn new(
        ...
        author: Option<models::SimpleUser>,
        publisher: Option<models::SimpleUser>,
        identifiers: Vec<models::GlobalAdvisoryIdentifiersInner>,
        state: State,
        ...
        submission: Option<models::RepositoryAdvisorySubmission>,
        vulnerabilities: Option<Vec<models::RepositoryAdvisoryVulnerability>>,
        cvss: Option<models::GlobalAdvisoryCvss>,
        cwes: Option<Vec<models::GlobalAdvisoryCwesInner>>,
        cwe_ids: Option<Vec<String>>,
        credits: Option<Vec<models::RepositoryAdvisoryCreditsInner>>,
        credits_detailed: Option<Vec<models::RepositoryAdvisoryCredit>>,
        collaborating_users: Option<Vec<models::SimpleUser>>,
        collaborating_teams: Option<Vec<models::Team>>,
        private_fork: Option<models::SimpleRepository>,
    ) -> RepositoryAdvisory {
        RepositoryAdvisory {
            ghsa_id,
            cve_id,
            ...
            publisher: if let Some(x) = publisher {
                Some(Box::new(x))
            } else {
                None
            },
            ...
            closed_at,
            withdrawn_at,
            submission: if let Some(x) = submission {
                Some(Box::new(x))
            } else {
                None
            },
            vulnerabilities,
            cvss: if let Some(x) = cvss {
                Some(Box::new(x))
            } else {
                None
            },
            ...
            collaborating_users,
            collaborating_teams,
            private_fork: if let Some(x) = private_fork {
                Some(Box::new(x))
            } else {
                None
            },
