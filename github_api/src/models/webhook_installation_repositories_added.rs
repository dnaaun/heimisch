...
pub struct WebhookInstallationRepositoriesAdded {
    ...
    pub repositories_removed:
        Vec<models::WebhookInstallationRepositoriesAddedRepositoriesRemovedInner>,
...
impl WebhookInstallationRepositoriesAdded {
    pub fn new(
        ...
        repositories_added: Vec<models::WebhooksRepositoriesInner>,
        repositories_removed: Vec<
            models::WebhookInstallationRepositoriesAddedRepositoriesRemovedInner,
        >,
        repository_selection: models::WebhooksRepositorySelection,
        requester: Option<models::WebhooksUser>,
        ...
        WebhookInstallationRepositoriesAdded {
            ...
            requester: if let Some(x) = requester {
                Some(Box::new(x))
            } else {
                None
            },
