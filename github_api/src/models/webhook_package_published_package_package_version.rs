...
pub struct WebhookPackagePublishedPackagePackageVersion {
    ...
    #[serde(
        rename = "container_metadata",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub container_metadata:
        Option<Option<Box<models::WebhookPackagePublishedPackagePackageVersionContainerMetadata>>>,
    ...
    pub npm_metadata:
        Option<Option<Box<models::WebhookPackagePublishedPackagePackageVersionNpmMetadata>>>,
    #[serde(
        rename = "nuget_metadata",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub nuget_metadata:
        Option<Option<Vec<models::WebhookPackagePublishedPackagePackageVersionNugetMetadataInner>>>,
...
impl WebhookPackagePublishedPackagePackageVersion {
    pub fn new(
        ...
        name: String,
        package_files: Vec<models::WebhookPackagePublishedPackagePackageVersionPackageFilesInner>,
        summary: String,
        version: String,
