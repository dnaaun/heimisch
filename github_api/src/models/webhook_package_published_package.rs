...
impl WebhookPackagePublishedPackage {
    ...
    pub fn new(
        ...
        name: String,
        namespace: String,
        owner: Option<models::User2>,
        package_type: String,
        package_version: Option<models::WebhookPackagePublishedPackagePackageVersion>,
        registry: Option<models::WebhookPackagePublishedPackageRegistry>,
