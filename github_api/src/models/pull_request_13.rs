...
impl PullRequest13 {
    pub fn new(
        ...
        assignee: Option<models::User2>,
        assignees: Vec<models::User>,
        author_association: AuthorAssociation,
        auto_merge: Option<models::PullRequestAutoMerge1>,
        base: models::PullRequestBase,
        body: Option<String>,
        ...
        diff_url: String,
        draft: bool,
        head: models::WebhookPullRequestReviewCommentDeletedPullRequestHead,
        html_url: String,
        id: i32,
        issue_url: String,
        ...
        milestone: Option<models::Milestone1>,
        node_id: String,
        number: i32,
        patch_url: String,
        requested_reviewers: Vec<models::PullRequest3RequestedReviewersInner>,
