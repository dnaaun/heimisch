...
pub struct RepositoryRulesetConditions {
    ...
    pub repository_property:
        Box<models::RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty>,
}

impl RepositoryRulesetConditions {
    pub fn new(
        repository_name: models::RepositoryRulesetConditionsRepositoryNameTargetRepositoryName,
        repository_id: models::RepositoryRulesetConditionsRepositoryIdTargetRepositoryId,
        repository_property: models::RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty,
