...
pub struct CodespaceWithFullRepository {
    ...
    #[serde(
        rename = "pending_operation_disabled_reason",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "retention_period_minutes",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
...
impl CodespaceWithFullRepository {
    ...
    pub fn new(
        ...
        owner: models::SimpleUser,
        billable_owner: models::SimpleUser,
        repository: models::FullRepository,
        machine: Option<models::NullableCodespaceMachine>,
        ...
        state: State,
        url: String,
        git_status: models::CodespaceGitStatus,
        location: Location,
