...
pub struct GlobalAdvisory {
    ...
    #[serde(
        rename = "repository_advisory_url",
...
impl GlobalAdvisory {
    ...
    pub fn new(
        ...
        identifiers: Option<Vec<models::GlobalAdvisoryIdentifiersInner>>,
        ...
        vulnerabilities: Option<Vec<models::Vulnerability>>,
        cvss: Option<models::GlobalAdvisoryCvss>,
        cwes: Option<Vec<models::GlobalAdvisoryCwesInner>>,
        credits: Option<Vec<models::GlobalAdvisoryCreditsInner>>,
    ) -> GlobalAdvisory {
        GlobalAdvisory {
            ghsa_id,
            cve_id,
