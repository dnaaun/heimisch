...
pub struct ReposUpdateBranchProtectionRequest {
    #[serde(
        rename = "required_status_checks",
        deserialize_with = "Option::deserialize"
    )]
    pub required_status_checks:
        Option<Box<models::ReposUpdateBranchProtectionRequestRequiredStatusChecks>>,
    /// Enforce all configured restrictions for administrators. Set to `true` to enforce required status checks for repository administrators. Set to `null` to disable.
    #[serde(rename = "enforce_admins", deserialize_with = "Option::deserialize")]
    pub enforce_admins: Option<bool>,
    #[serde(
        rename = "required_pull_request_reviews",
        deserialize_with = "Option::deserialize"
    )]
    pub required_pull_request_reviews:
        Option<Box<models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviews>>,
    ...
    #[serde(
        rename = "required_conversation_resolution",
        skip_serializing_if = "Option::is_none"
    )]
...
impl ReposUpdateBranchProtectionRequest {
    pub fn new(
        required_status_checks: Option<
            models::ReposUpdateBranchProtectionRequestRequiredStatusChecks,
        >,
        enforce_admins: Option<bool>,
        required_pull_request_reviews: Option<
            models::ReposUpdateBranchProtectionRequestRequiredPullRequestReviews,
        >,
        restrictions: Option<models::ReposUpdateBranchProtectionRequestRestrictions>,
    ) -> ReposUpdateBranchProtectionRequest {
        ReposUpdateBranchProtectionRequest {
            required_status_checks: if let Some(x) = required_status_checks {
                Some(Box::new(x))
            } else {
                None
            },
            enforce_admins,
            required_pull_request_reviews: if let Some(x) = required_pull_request_reviews {
                Some(Box::new(x))
            } else {
                None
            },
            restrictions: if let Some(x) = restrictions {
                Some(Box::new(x))
            } else {
                None
            },
