...
impl WebhooksSecurityAdvisory {
    ...
    pub fn new(
        cvss: models::WebhooksSecurityAdvisoryCvss,
        cwes: Vec<models::WebhooksSecurityAdvisoryCwesInner>,
        description: String,
        ghsa_id: String,
        identifiers: Vec<models::WebhooksSecurityAdvisoryIdentifiersInner>,
        published_at: String,
        references: Vec<models::WebhooksSecurityAdvisoryReferencesInner>,
        severity: String,
        summary: String,
        updated_at: String,
        vulnerabilities: Vec<models::WebhooksSecurityAdvisoryVulnerabilitiesInner>,
