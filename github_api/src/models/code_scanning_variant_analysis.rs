...
pub struct CodeScanningVariantAnalysis {
    ...
    #[serde(
        rename = "actions_workflow_run_id",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "scanned_repositories",
        skip_serializing_if = "Option::is_none"
    )]
    pub scanned_repositories:
        Option<Vec<models::CodeScanningVariantAnalysisScannedRepositoriesInner>>,
    #[serde(
        rename = "skipped_repositories",
        skip_serializing_if = "Option::is_none"
    )]
...
impl CodeScanningVariantAnalysis {
    ...
    pub fn new(
        id: i32,
        controller_repo: models::SimpleRepository,
        actor: models::SimpleUser,
        query_language: models::CodeScanningVariantAnalysisLanguage,
