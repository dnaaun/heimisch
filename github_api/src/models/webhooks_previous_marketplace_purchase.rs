...
impl WebhooksPreviousMarketplacePurchase {
    pub fn new(
        account: models::WebhooksMarketplacePurchaseAccount,
        billing_cycle: String,
        free_trial_ends_on: Option<serde_json::Value>,
        on_free_trial: bool,
        plan: models::WebhooksPreviousMarketplacePurchasePlan,
        unit_count: i32,
