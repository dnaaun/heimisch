...
impl CodeScanningVariantAnalysisRepoTask {
    pub fn new(
        repository: models::SimpleRepository,
        analysis_status: models::CodeScanningVariantAnalysisStatus,
