...
impl DependabotAlertSecurityAdvisory {
    ...
    pub fn new(
        ...
        summary: String,
        description: String,
        vulnerabilities: Vec<models::DependabotAlertSecurityVulnerability>,
        severity: Severity,
        cvss: models::DependabotAlertSecurityAdvisoryCvss,
        cwes: Vec<models::DependabotAlertSecurityAdvisoryCwesInner>,
        identifiers: Vec<models::DependabotAlertSecurityAdvisoryIdentifiersInner>,
        references: Vec<models::DependabotAlertSecurityAdvisoryReferencesInner>,
        published_at: String,
        updated_at: String,
