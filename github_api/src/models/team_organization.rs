...
pub struct TeamOrganization {
    ...
    pub r#type: String,
    #[serde(
        rename = "total_private_repos",
        skip_serializing_if = "Option::is_none"
    )]
    pub total_private_repos: Option<i32>,
    #[serde(
        rename = "owned_private_repos",
        skip_serializing_if = "Option::is_none"
    )]
    pub owned_private_repos: Option<i32>,
    #[serde(
        rename = "private_gists",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "two_factor_requirement_enabled",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
