...
pub struct WebhookRegistryPackagePublishedRegistryPackage {
    ...
    pub package_version:
        Option<Box<models::WebhookRegistryPackagePublishedRegistryPackagePackageVersion>>,
...
impl WebhookRegistryPackagePublishedRegistryPackage {
    pub fn new(
        ...
        name: String,
        namespace: String,
        owner: models::WebhookRegistryPackagePublishedRegistryPackageOwner,
        package_type: String,
        package_version: Option<
            models::WebhookRegistryPackagePublishedRegistryPackagePackageVersion,
        >,
        registry: Option<models::WebhookRegistryPackagePublishedRegistryPackageRegistry>,
        ...
        WebhookRegistryPackagePublishedRegistryPackage {
            ...
            owner: Box::new(owner),
            package_type,
            package_version: if let Some(x) = package_version {
                Some(Box::new(x))
            } else {
                None
            },
            registry: if let Some(x) = registry {
                Some(Box::new(x))
            } else {
                None
            },
