...
impl PullRequest6 {
    pub fn new(
        ...
        assignees: Vec<models::User2>,
        author_association: AuthorAssociation,
        auto_merge: Option<models::PullRequestAutoMerge>,
        base: models::PullRequest6Base,
        body: Option<String>,
        ...
        number: i32,
        patch_url: String,
        requested_reviewers: Vec<models::PullRequest6RequestedReviewersInner>,
        requested_teams: Vec<models::Team1>,
