...
pub struct WorkflowRun2 {
    ...
    #[serde(
        rename = "referenced_workflows",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub referenced_workflows:
        Option<Option<Vec<models::DeploymentWorkflowRunReferencedWorkflowsInner>>>,
...
impl WorkflowRun2 {
    pub fn new(
        ...
        head_commit: models::SimpleCommit,
        head_repository: models::RepositoryLite,
        head_sha: String,
        html_url: String,
        id: i32,
        jobs_url: String,
        ...
        pull_requests: Vec<models::WorkflowRun2PullRequestsInner>,
        repository: models::RepositoryLite,
        rerun_url: String,
        run_attempt: i32,
        run_number: i32,
        run_started_at: String,
        status: Status,
        triggering_actor: Option<models::User2>,
        updated_at: String,
        url: String,
        workflow_id: i32,
        workflow_url: String,
        ...
        WorkflowRun2 {
            ...
            run_started_at,
            status,
            triggering_actor: if let Some(x) = triggering_actor {
                Some(Box::new(x))
            } else {
                None
            },
