...
pub struct ProtectedBranch {
    ...
    pub required_pull_request_reviews:
        Option<Box<models::ProtectedBranchRequiredPullRequestReviews>>,
    #[serde(
        rename = "required_signatures",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub required_conversation_resolution:
        Option<Box<models::ProtectedBranchRequiredConversationResolution>>,
