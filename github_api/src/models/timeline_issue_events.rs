...
impl TimelineIssueEvents {
    ...
    pub fn new(
        ...
        label: models::LabeledIssueEventLabel,
        milestone: models::MilestonedIssueEventMilestone,
        rename: models::RenamedIssueEventRename,
        review_requester: models::SimpleUser,
        dismissed_review: models::ReviewDismissedIssueEventDismissedReview,
        ...
        updated_at: String,
        issue_url: String,
        author_association: models::AuthorAssociation,
        source: models::TimelineCrossReferencedEventSource,
        sha: String,
        author: models::GitCommitAuthor,
        committer: models::GitCommitAuthor,
        message: String,
        tree: models::GitCommitTree,
        parents: Vec<models::GitCommitParentsInner>,
        verification: models::GitCommitVerification,
        state: String,
        pull_request_url: String,
        _links: models::TimelineReviewedEventLinks,
        assignee: models::SimpleUser,
    ) -> TimelineIssueEvents {
        TimelineIssueEvents {
            id,
            node_id,
