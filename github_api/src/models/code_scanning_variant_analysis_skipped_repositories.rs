...
impl CodeScanningVariantAnalysisSkippedRepositories {
    ...
    pub fn new(
        access_mismatch_repos: models::CodeScanningVariantAnalysisSkippedRepoGroup,
        not_found_repos: models::CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos,
        no_codeql_db_repos: models::CodeScanningVariantAnalysisSkippedRepoGroup,
        over_limit_repos: models::CodeScanningVariantAnalysisSkippedRepoGroup,
