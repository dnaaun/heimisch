...
pub struct WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
    ...
    pub docker_metadata: Option<
        Vec<models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionDockerMetadataInner>,
    >,
    ...
    pub package_files:
        Vec<models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionPackageFilesInner>,
    ...
    pub release:
        Option<Box<models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionRelease>>,
...
impl WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
    pub fn new(
        author: models::WebhookRegistryPackagePublishedRegistryPackageOwner,
        body: String,
        body_html: String,
        created_at: String,
        description: String,
        ...
        name: String,
        package_files: Vec<
            models::WebhookRegistryPackageUpdatedRegistryPackagePackageVersionPackageFilesInner,
        >,
        package_url: String,
        summary: String,
