...
pub struct CopilotUsageMetrics {
    ...
    #[serde(
        rename = "total_active_chat_users",
        skip_serializing_if = "Option::is_none"
    )]
...
impl CopilotUsageMetrics {
    ...
    pub fn new(
        day: String,
        breakdown: Option<Vec<models::CopilotUsageMetricsBreakdownInner>>,
    ) -> CopilotUsageMetrics {
        CopilotUsageMetrics {
            day,
