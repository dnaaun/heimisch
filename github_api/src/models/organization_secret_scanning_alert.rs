...
pub struct OrganizationSecretScanningAlert {
    ...
    #[serde(
        rename = "secret_type_display_name",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "push_protection_bypassed",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "push_protection_bypassed_by",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "push_protection_bypassed_at",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
