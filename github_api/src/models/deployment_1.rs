...
impl Deployment1 {
    ...
    pub fn new(
        created_at: String,
        creator: Option<models::User2>,
        description: Option<String>,
        environment: String,
        id: i32,
        node_id: String,
        original_environment: String,
        payload: Option<models::Deployment1Payload>,
        r#ref: String,
