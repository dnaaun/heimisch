...
pub async fn licenses_slash_get(
    configuration: &configuration::Configuration,
    license: &str,
) -> Result<models::License, Error<LicensesSlashGetError>> {
    ...
    let local_var_uri_str = format!(
        ...
        license = crate::apis::urlencode(license)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LicensesSlashGetError> =
...
pub async fn licenses_slash_get_all_commonly_used(
    configuration: &configuration::Configuration,
    featured: Option<bool>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::LicenseSimple>, Error<LicensesSlashGetAllCommonlyUsedError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LicensesSlashGetAllCommonlyUsedError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn licenses_slash_get_for_repo(
    ...
    repo: &str,
    r#ref: Option<&str>,
) -> Result<models::LicenseContent, Error<LicensesSlashGetForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LicensesSlashGetForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
