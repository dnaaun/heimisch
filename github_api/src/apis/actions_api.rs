...
pub async fn actions_slash_add_custom_labels_to_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
    actions_add_custom_labels_to_self_hosted_runner_for_org_request: models::ActionsAddCustomLabelsToSelfHostedRunnerForOrgRequest,
) -> Result<
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
...
> {
    ...
    local_var_req_builder = local_var_req_builder
        .json(&actions_add_custom_labels_to_self_hosted_runner_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddCustomLabelsToSelfHostedRunnerForOrgError> =
...
pub async fn actions_slash_add_custom_labels_to_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddCustomLabelsToSelfHostedRunnerForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_add_repo_access_to_self_hosted_runner_group_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashAddRepoAccessToSelfHostedRunnerGroupInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddRepoAccessToSelfHostedRunnerGroupInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_add_selected_repo_to_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashAddSelectedRepoToOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddSelectedRepoToOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_add_selected_repo_to_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashAddSelectedRepoToOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddSelectedRepoToOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_add_self_hosted_runner_to_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    runner_id: i32,
) -> Result<(), Error<ActionsSlashAddSelfHostedRunnerToGroupForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashAddSelfHostedRunnerToGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_approve_workflow_run(
    ...
    repo: &str,
    run_id: i32,
) -> Result<serde_json::Value, Error<ActionsSlashApproveWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashApproveWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_cancel_workflow_run(
    ...
    repo: &str,
    run_id: i32,
) -> Result<serde_json::Value, Error<ActionsSlashCancelWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCancelWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_environment_variable(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    environment_name: &str,
    actions_create_repo_variable_request: models::ActionsCreateRepoVariableRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateEnvironmentVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateEnvironmentVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_or_update_environment_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    environment_name: &str,
    secret_name: &str,
    actions_create_or_update_environment_secret_request: models::ActionsCreateOrUpdateEnvironmentSecretRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateOrUpdateEnvironmentSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_create_or_update_environment_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateOrUpdateEnvironmentSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_or_update_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    actions_create_or_update_org_secret_request: models::ActionsCreateOrUpdateOrgSecretRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateOrUpdateOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_create_or_update_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateOrUpdateOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_or_update_repo_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_name: &str,
    actions_create_or_update_repo_secret_request: models::ActionsCreateOrUpdateRepoSecretRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateOrUpdateRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_create_or_update_repo_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateOrUpdateRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    actions_create_org_variable_request: models::ActionsCreateOrgVariableRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_registration_token_for_org(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::AuthenticationToken, Error<ActionsSlashCreateRegistrationTokenForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateRegistrationTokenForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_registration_token_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::AuthenticationToken, Error<ActionsSlashCreateRegistrationTokenForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateRegistrationTokenForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_remove_token_for_org(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::AuthenticationToken, Error<ActionsSlashCreateRemoveTokenForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateRemoveTokenForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_remove_token_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::AuthenticationToken, Error<ActionsSlashCreateRemoveTokenForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateRemoveTokenForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_repo_variable(
    ...
    repo: &str,
    actions_create_repo_variable_request: models::ActionsCreateRepoVariableRequest,
) -> Result<serde_json::Value, Error<ActionsSlashCreateRepoVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateRepoVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_self_hosted_runner_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    actions_create_self_hosted_runner_group_for_org_request: models::ActionsCreateSelfHostedRunnerGroupForOrgRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_create_self_hosted_runner_group_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateSelfHostedRunnerGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_create_workflow_dispatch(
    ...
    owner: &str,
    repo: &str,
    workflow_id: models::ActionsGetWorkflowWorkflowIdParameter,
    actions_create_workflow_dispatch_request: models::ActionsCreateWorkflowDispatchRequest,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashCreateWorkflowDispatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_actions_cache_by_id(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteActionsCacheByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_actions_cache_by_key(
    ...
    key: &str,
    r#ref: Option<&str>,
) -> Result<models::ActionsCacheList, Error<ActionsSlashDeleteActionsCacheByKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteActionsCacheByKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_artifact(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteArtifactError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_environment_secret(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteEnvironmentSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_environment_variable(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    name: &str,
    environment_name: &str,
) -> Result<(), Error<ActionsSlashDeleteEnvironmentVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteEnvironmentVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
) -> Result<(), Error<ActionsSlashDeleteOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
) -> Result<(), Error<ActionsSlashDeleteOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_repo_secret(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_repo_variable(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteRepoVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_self_hosted_runner_from_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
) -> Result<(), Error<ActionsSlashDeleteSelfHostedRunnerFromOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteSelfHostedRunnerFromOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_self_hosted_runner_from_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
) -> Result<(), Error<ActionsSlashDeleteSelfHostedRunnerFromRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteSelfHostedRunnerFromRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_self_hosted_runner_group_from_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
) -> Result<(), Error<ActionsSlashDeleteSelfHostedRunnerGroupFromOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteSelfHostedRunnerGroupFromOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_workflow_run(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_delete_workflow_run_logs(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDeleteWorkflowRunLogsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_disable_selected_repository_github_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashDisableSelectedRepositoryGithubActionsOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashDisableSelectedRepositoryGithubActionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_disable_workflow(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDisableWorkflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_download_artifact(
    ...
    let local_var_uri_str = format!(
        ...
        repo = crate::apis::urlencode(repo),
        artifact_id = artifact_id,
        archive_format = crate::apis::urlencode(archive_format)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDownloadArtifactError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_download_job_logs_for_workflow_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    job_id: i32,
) -> Result<(), Error<ActionsSlashDownloadJobLogsForWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDownloadJobLogsForWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_download_workflow_run_attempt_logs(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    attempt_number: i32,
) -> Result<(), Error<ActionsSlashDownloadWorkflowRunAttemptLogsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDownloadWorkflowRunAttemptLogsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_download_workflow_run_logs(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashDownloadWorkflowRunLogsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_enable_selected_repository_github_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashEnableSelectedRepositoryGithubActionsOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashEnableSelectedRepositoryGithubActionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_enable_workflow(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashEnableWorkflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_force_cancel_workflow_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
) -> Result<serde_json::Value, Error<ActionsSlashForceCancelWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashForceCancelWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_generate_runner_jitconfig_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    actions_generate_runner_jitconfig_for_org_request: models::ActionsGenerateRunnerJitconfigForOrgRequest,
) -> Result<
    models::ActionsGenerateRunnerJitconfigForOrg201Response,
...
> {
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_generate_runner_jitconfig_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGenerateRunnerJitconfigForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_generate_runner_jitconfig_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actions_generate_runner_jitconfig_for_org_request: models::ActionsGenerateRunnerJitconfigForOrgRequest,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGenerateRunnerJitconfigForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_actions_cache_list(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
...
) -> Result<models::ActionsCacheList, Error<ActionsSlashGetActionsCacheListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetActionsCacheListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_actions_cache_usage(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::ActionsCacheUsageByRepository, Error<ActionsSlashGetActionsCacheUsageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetActionsCacheUsageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_actions_cache_usage_by_repo_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    models::ActionsGetActionsCacheUsageByRepoForOrg200Response,
    Error<ActionsSlashGetActionsCacheUsageByRepoForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetActionsCacheUsageByRepoForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_actions_cache_usage_for_org(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<
    models::ActionsCacheUsageOrgEnterprise,
    Error<ActionsSlashGetActionsCacheUsageForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetActionsCacheUsageForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_allowed_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::SelectedActions, Error<ActionsSlashGetAllowedActionsOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetAllowedActionsOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_allowed_actions_repository(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::SelectedActions, Error<ActionsSlashGetAllowedActionsRepositoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetAllowedActionsRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_artifact(
    ...
    repo: &str,
    artifact_id: i32,
) -> Result<models::Artifact, Error<ActionsSlashGetArtifactError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetArtifactError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_custom_oidc_sub_claim_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::OidcCustomSubRepo, Error<ActionsSlashGetCustomOidcSubClaimForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetCustomOidcSubClaimForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_environment_public_key(
    ...
    repo: &str,
    environment_name: &str,
) -> Result<models::ActionsPublicKey, Error<ActionsSlashGetEnvironmentPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetEnvironmentPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_environment_secret(
    ...
    environment_name: &str,
    secret_name: &str,
) -> Result<models::ActionsSecret, Error<ActionsSlashGetEnvironmentSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetEnvironmentSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_environment_variable(
    ...
    environment_name: &str,
    name: &str,
) -> Result<models::ActionsVariable, Error<ActionsSlashGetEnvironmentVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetEnvironmentVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_github_actions_default_workflow_permissions_organization(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<
    models::ActionsGetDefaultWorkflowPermissions,
    Error<ActionsSlashGetGithubActionsDefaultWorkflowPermissionsOrganizationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashGetGithubActionsDefaultWorkflowPermissionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_github_actions_default_workflow_permissions_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<
    models::ActionsGetDefaultWorkflowPermissions,
    Error<ActionsSlashGetGithubActionsDefaultWorkflowPermissionsRepositoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashGetGithubActionsDefaultWorkflowPermissionsRepositoryError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_github_actions_permissions_organization(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<
    models::ActionsOrganizationPermissions,
    Error<ActionsSlashGetGithubActionsPermissionsOrganizationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetGithubActionsPermissionsOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_github_actions_permissions_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<
    models::ActionsRepositoryPermissions,
    Error<ActionsSlashGetGithubActionsPermissionsRepositoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetGithubActionsPermissionsRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_job_for_workflow_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    job_id: i32,
) -> Result<models::Job, Error<ActionsSlashGetJobForWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetJobForWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_org_public_key(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::ActionsPublicKey, Error<ActionsSlashGetOrgPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetOrgPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
) -> Result<models::OrganizationActionsSecret, Error<ActionsSlashGetOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
) -> Result<models::OrganizationActionsVariable, Error<ActionsSlashGetOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_pending_deployments_for_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
) -> Result<Vec<models::PendingDeployment>, Error<ActionsSlashGetPendingDeploymentsForRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetPendingDeploymentsForRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_repo_public_key(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::ActionsPublicKey, Error<ActionsSlashGetRepoPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetRepoPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_repo_secret(
    ...
    repo: &str,
    secret_name: &str,
) -> Result<models::ActionsSecret, Error<ActionsSlashGetRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_repo_variable(
    ...
    repo: &str,
    name: &str,
) -> Result<models::ActionsVariable, Error<ActionsSlashGetRepoVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetRepoVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_reviews_for_run(
    ...
    repo: &str,
    run_id: i32,
) -> Result<Vec<models::EnvironmentApprovals>, Error<ActionsSlashGetReviewsForRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetReviewsForRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
) -> Result<models::Runner, Error<ActionsSlashGetSelfHostedRunnerForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetSelfHostedRunnerForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
) -> Result<models::Runner, Error<ActionsSlashGetSelfHostedRunnerForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetSelfHostedRunnerForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_self_hosted_runner_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
) -> Result<models::RunnerGroupsOrg, Error<ActionsSlashGetSelfHostedRunnerGroupForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetSelfHostedRunnerGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow(
    ...
    repo: &str,
    workflow_id: models::ActionsGetWorkflowWorkflowIdParameter,
) -> Result<models::Workflow, Error<ActionsSlashGetWorkflowError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow_access_to_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<
    models::ActionsWorkflowAccessToRepository,
    Error<ActionsSlashGetWorkflowAccessToRepositoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowAccessToRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow_run(
...
) -> Result<models::WorkflowRun, Error<ActionsSlashGetWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_pull_requests {
        local_var_req_builder =
            local_var_req_builder.query(&[("exclude_pull_requests", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow_run_attempt(
    ...
    attempt_number: i32,
    exclude_pull_requests: Option<bool>,
) -> Result<models::WorkflowRun, Error<ActionsSlashGetWorkflowRunAttemptError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowRunAttemptError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow_run_usage(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
) -> Result<models::WorkflowRunUsage, Error<ActionsSlashGetWorkflowRunUsageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowRunUsageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_get_workflow_usage(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    workflow_id: models::ActionsGetWorkflowWorkflowIdParameter,
) -> Result<models::WorkflowUsage, Error<ActionsSlashGetWorkflowUsageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashGetWorkflowUsageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_artifacts_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::ActionsListArtifactsForRepo200Response,
    Error<ActionsSlashListArtifactsForRepoError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListArtifactsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_environment_secrets(
    ...
    models::ActionsListRepoOrganizationSecrets200Response,
    Error<ActionsSlashListEnvironmentSecretsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListEnvironmentSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_environment_variables(
    ...
    models::ActionsListRepoOrganizationVariables200Response,
    Error<ActionsSlashListEnvironmentVariablesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListEnvironmentVariablesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_jobs_for_workflow_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    ...
    models::ActionsListJobsForWorkflowRunAttempt200Response,
    Error<ActionsSlashListJobsForWorkflowRunError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListJobsForWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_jobs_for_workflow_run_attempt(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    ...
    models::ActionsListJobsForWorkflowRunAttempt200Response,
    Error<ActionsSlashListJobsForWorkflowRunAttemptError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListJobsForWorkflowRunAttemptError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_labels_for_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
) -> Result<
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
    Error<ActionsSlashListLabelsForSelfHostedRunnerForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListLabelsForSelfHostedRunnerForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_labels_for_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
    ...
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
    Error<ActionsSlashListLabelsForSelfHostedRunnerForRepoError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListLabelsForSelfHostedRunnerForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_org_secrets(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ActionsListOrgSecrets200Response, Error<ActionsSlashListOrgSecretsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListOrgSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_org_variables(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ActionsListOrgVariables200Response, Error<ActionsSlashListOrgVariablesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListOrgVariablesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_access_to_self_hosted_runner_group_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    page: Option<i32>,
    ...
    models::ActionsListRepoAccessToSelfHostedRunnerGroupInOrg200Response,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoAccessToSelfHostedRunnerGroupInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_organization_secrets(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::ActionsListRepoOrganizationSecrets200Response,
    Error<ActionsSlashListRepoOrganizationSecretsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoOrganizationSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_organization_variables(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::ActionsListRepoOrganizationVariables200Response,
    Error<ActionsSlashListRepoOrganizationVariablesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoOrganizationVariablesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_secrets(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::ActionsListRepoOrganizationSecrets200Response,
    Error<ActionsSlashListRepoSecretsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_variables(
    ...
    models::ActionsListRepoOrganizationVariables200Response,
    Error<ActionsSlashListRepoVariablesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoVariablesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_repo_workflows(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ActionsListRepoWorkflows200Response, Error<ActionsSlashListRepoWorkflowsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRepoWorkflowsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_runner_applications_for_org(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<Vec<models::RunnerApplication>, Error<ActionsSlashListRunnerApplicationsForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRunnerApplicationsForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_runner_applications_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<models::RunnerApplication>, Error<ActionsSlashListRunnerApplicationsForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListRunnerApplicationsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    page: Option<i32>,
    ...
    models::ActionsListSelectedReposForOrgSecret200Response,
    Error<ActionsSlashListSelectedReposForOrgSecretError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_selected_repos_for_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
    page: Option<i32>,
    ...
    models::ActionsListSelectedReposForOrgSecret200Response,
    Error<ActionsSlashListSelectedReposForOrgVariableError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelectedReposForOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_selected_repositories_enabled_github_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    models::ActionsListSelectedRepositoriesEnabledGithubActionsOrganization200Response,
    Error<ActionsSlashListSelectedRepositoriesEnabledGithubActionsOrganizationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashListSelectedRepositoriesEnabledGithubActionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_self_hosted_runner_groups_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    models::ActionsListSelfHostedRunnerGroupsForOrg200Response,
...
> {
    ...
    if let Some(ref local_var_str) = visible_to_repository {
        local_var_req_builder =
            local_var_req_builder.query(&[("visible_to_repository", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelfHostedRunnerGroupsForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_self_hosted_runners_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    name: Option<&str>,
    per_page: Option<i32>,
    ...
    models::ActionsListSelfHostedRunnersForOrg200Response,
    Error<ActionsSlashListSelfHostedRunnersForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelfHostedRunnersForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_self_hosted_runners_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    name: Option<&str>,
    ...
    models::ActionsListSelfHostedRunnersForOrg200Response,
    Error<ActionsSlashListSelfHostedRunnersForRepoError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelfHostedRunnersForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_self_hosted_runners_in_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    per_page: Option<i32>,
    ...
    models::ActionsListSelfHostedRunnersInGroupForOrg200Response,
    Error<ActionsSlashListSelfHostedRunnersInGroupForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListSelfHostedRunnersInGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_workflow_run_artifacts(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    ...
    models::ActionsListArtifactsForRepo200Response,
    Error<ActionsSlashListWorkflowRunArtifactsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListWorkflowRunArtifactsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_workflow_runs(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    workflow_id: models::ActionsGetWorkflowWorkflowIdParameter,
    ...
    models::ActionsListWorkflowRunsForRepo200Response,
...
> {
    ...
    if let Some(ref local_var_str) = event {
        local_var_req_builder =
            local_var_req_builder.query(&[("event", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = check_suite_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("check_suite_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = head_sha {
        local_var_req_builder =
            local_var_req_builder.query(&[("head_sha", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListWorkflowRunsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_list_workflow_runs_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actor: Option<&str>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashListWorkflowRunsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_re_run_job_for_workflow_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    job_id: i32,
    actions_re_run_job_for_workflow_run_request: Option<
        models::ActionsReRunJobForWorkflowRunRequest,
    >,
) -> Result<serde_json::Value, Error<ActionsSlashReRunJobForWorkflowRunError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_re_run_job_for_workflow_run_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashReRunJobForWorkflowRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_re_run_workflow(
    ...
    actions_re_run_job_for_workflow_run_request: Option<
        models::ActionsReRunJobForWorkflowRunRequest,
    >,
) -> Result<serde_json::Value, Error<ActionsSlashReRunWorkflowError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashReRunWorkflowError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_re_run_workflow_failed_jobs(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    actions_re_run_job_for_workflow_run_request: Option<
        models::ActionsReRunJobForWorkflowRunRequest,
    >,
) -> Result<serde_json::Value, Error<ActionsSlashReRunWorkflowFailedJobsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashReRunWorkflowFailedJobsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_all_custom_labels_from_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
) -> Result<
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
    Error<ActionsSlashRemoveAllCustomLabelsFromSelfHostedRunnerForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashRemoveAllCustomLabelsFromSelfHostedRunnerForOrgError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_all_custom_labels_from_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashRemoveAllCustomLabelsFromSelfHostedRunnerForRepoError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_custom_label_from_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
    name: &str,
    ...
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
    Error<ActionsSlashRemoveCustomLabelFromSelfHostedRunnerForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashRemoveCustomLabelFromSelfHostedRunnerForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_custom_label_from_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashRemoveCustomLabelFromSelfHostedRunnerForRepoError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_repo_access_to_self_hosted_runner_group_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashRemoveRepoAccessToSelfHostedRunnerGroupInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashRemoveRepoAccessToSelfHostedRunnerGroupInOrgError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_selected_repo_from_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashRemoveSelectedRepoFromOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashRemoveSelectedRepoFromOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_selected_repo_from_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
    repository_id: i32,
) -> Result<(), Error<ActionsSlashRemoveSelectedRepoFromOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashRemoveSelectedRepoFromOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_remove_self_hosted_runner_from_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    runner_id: i32,
) -> Result<(), Error<ActionsSlashRemoveSelfHostedRunnerFromGroupForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashRemoveSelfHostedRunnerFromGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_review_custom_gates_for_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    actions_review_custom_gates_for_run_request: models::ActionsReviewCustomGatesForRunRequest,
) -> Result<(), Error<ActionsSlashReviewCustomGatesForRunError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_review_custom_gates_for_run_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashReviewCustomGatesForRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_review_pending_deployments_for_run(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    run_id: i32,
    actions_review_pending_deployments_for_run_request: models::ActionsReviewPendingDeploymentsForRunRequest,
) -> Result<Vec<models::Deployment>, Error<ActionsSlashReviewPendingDeploymentsForRunError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_review_pending_deployments_for_run_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashReviewPendingDeploymentsForRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_allowed_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    selected_actions: Option<models::SelectedActions>,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetAllowedActionsOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_allowed_actions_repository(
    ...
    repo: &str,
    selected_actions: Option<models::SelectedActions>,
) -> Result<(), Error<ActionsSlashSetAllowedActionsRepositoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetAllowedActionsRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_custom_labels_for_self_hosted_runner_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_id: i32,
    actions_set_custom_labels_for_self_hosted_runner_for_org_request: models::ActionsSetCustomLabelsForSelfHostedRunnerForOrgRequest,
) -> Result<
    models::ActionsListLabelsForSelfHostedRunnerForOrg200Response,
...
> {
    ...
    local_var_req_builder = local_var_req_builder
        .json(&actions_set_custom_labels_for_self_hosted_runner_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetCustomLabelsForSelfHostedRunnerForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_custom_labels_for_self_hosted_runner_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    runner_id: i32,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetCustomLabelsForSelfHostedRunnerForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_custom_oidc_sub_claim_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actions_oidc_subject_customization_for_a_repository: models::ActionsOidcSubjectCustomizationForARepository,
) -> Result<serde_json::Value, Error<ActionsSlashSetCustomOidcSubClaimForRepoError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_oidc_subject_customization_for_a_repository);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetCustomOidcSubClaimForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_github_actions_default_workflow_permissions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    actions_set_default_workflow_permissions: Option<models::ActionsSetDefaultWorkflowPermissions>,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashSetGithubActionsDefaultWorkflowPermissionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_github_actions_default_workflow_permissions_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actions_set_default_workflow_permissions: models::ActionsSetDefaultWorkflowPermissions,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashSetGithubActionsDefaultWorkflowPermissionsRepositoryError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_github_actions_permissions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    actions_set_github_actions_permissions_organization_request: models::ActionsSetGithubActionsPermissionsOrganizationRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_set_github_actions_permissions_organization_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetGithubActionsPermissionsOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_github_actions_permissions_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actions_set_github_actions_permissions_repository_request: models::ActionsSetGithubActionsPermissionsRepositoryRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_set_github_actions_permissions_repository_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetGithubActionsPermissionsRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_repo_access_to_self_hosted_runner_group_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    actions_set_repo_access_to_self_hosted_runner_group_in_org_request: models::ActionsSetRepoAccessToSelfHostedRunnerGroupInOrgRequest,
) -> Result<(), Error<ActionsSlashSetRepoAccessToSelfHostedRunnerGroupInOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder
        .json(&actions_set_repo_access_to_self_hosted_runner_group_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetRepoAccessToSelfHostedRunnerGroupInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    actions_set_selected_repos_for_org_secret_request: models::ActionsSetSelectedReposForOrgSecretRequest,
) -> Result<(), Error<ActionsSlashSetSelectedReposForOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_set_selected_repos_for_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_selected_repos_for_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
    actions_set_selected_repos_for_org_variable_request: models::ActionsSetSelectedReposForOrgVariableRequest,
) -> Result<(), Error<ActionsSlashSetSelectedReposForOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_set_selected_repos_for_org_variable_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetSelectedReposForOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_selected_repositories_enabled_github_actions_organization(
    configuration: &configuration::Configuration,
    org: &str,
    actions_set_selected_repositories_enabled_github_actions_organization_request: models::ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest,
    ...
    local_var_req_builder = local_var_req_builder
        .json(&actions_set_selected_repositories_enabled_github_actions_organization_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ActionsSlashSetSelectedRepositoriesEnabledGithubActionsOrganizationError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_self_hosted_runners_in_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    actions_set_self_hosted_runners_in_group_for_org_request: models::ActionsSetSelfHostedRunnersInGroupForOrgRequest,
) -> Result<(), Error<ActionsSlashSetSelfHostedRunnersInGroupForOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_set_self_hosted_runners_in_group_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetSelfHostedRunnersInGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_set_workflow_access_to_repository(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    actions_workflow_access_to_repository: models::ActionsWorkflowAccessToRepository,
) -> Result<(), Error<ActionsSlashSetWorkflowAccessToRepositoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashSetWorkflowAccessToRepositoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_update_environment_variable(
    ...
    name: &str,
    environment_name: &str,
    actions_update_repo_variable_request: models::ActionsUpdateRepoVariableRequest,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashUpdateEnvironmentVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_update_org_variable(
    configuration: &configuration::Configuration,
    org: &str,
    name: &str,
    actions_update_org_variable_request: models::ActionsUpdateOrgVariableRequest,
) -> Result<(), Error<ActionsSlashUpdateOrgVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashUpdateOrgVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_update_repo_variable(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    name: &str,
    actions_update_repo_variable_request: models::ActionsUpdateRepoVariableRequest,
) -> Result<(), Error<ActionsSlashUpdateRepoVariableError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashUpdateRepoVariableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn actions_slash_update_self_hosted_runner_group_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    runner_group_id: i32,
    actions_update_self_hosted_runner_group_for_org_request: models::ActionsUpdateSelfHostedRunnerGroupForOrgRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&actions_update_self_hosted_runner_group_for_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActionsSlashUpdateSelfHostedRunnerGroupForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
