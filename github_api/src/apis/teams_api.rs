...
pub async fn teams_slash_add_member_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    username: &str,
) -> Result<(), Error<TeamsSlashAddMemberLegacyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddMemberLegacyError> =
...
pub async fn teams_slash_add_or_update_membership_for_user_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    username: &str,
    teams_add_or_update_membership_for_user_in_org_request: Option<
        models::TeamsAddOrUpdateMembershipForUserInOrgRequest,
    >,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_add_or_update_membership_for_user_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateMembershipForUserInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_add_or_update_membership_for_user_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    username: &str,
    teams_add_or_update_membership_for_user_in_org_request: Option<
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateMembershipForUserLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_add_or_update_project_permissions_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    project_id: i32,
    teams_add_or_update_project_permissions_in_org_request: Option<
        models::TeamsAddOrUpdateProjectPermissionsInOrgRequest,
    >,
) -> Result<(), Error<TeamsSlashAddOrUpdateProjectPermissionsInOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_add_or_update_project_permissions_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateProjectPermissionsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_add_or_update_project_permissions_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    project_id: i32,
    teams_add_or_update_project_permissions_legacy_request: Option<
        models::TeamsAddOrUpdateProjectPermissionsLegacyRequest,
    >,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_add_or_update_project_permissions_legacy_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateProjectPermissionsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_add_or_update_repo_permissions_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    owner: &str,
    repo: &str,
    teams_add_or_update_repo_permissions_in_org_request: Option<
        models::TeamsAddOrUpdateRepoPermissionsInOrgRequest,
    >,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_add_or_update_repo_permissions_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateRepoPermissionsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_add_or_update_repo_permissions_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    owner: &str,
    repo: &str,
    teams_add_or_update_repo_permissions_legacy_request: Option<
        models::TeamsAddOrUpdateRepoPermissionsLegacyRequest,
    >,
) -> Result<(), Error<TeamsSlashAddOrUpdateRepoPermissionsLegacyError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_add_or_update_repo_permissions_legacy_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashAddOrUpdateRepoPermissionsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_check_permissions_for_project_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    project_id: i32,
) -> Result<models::TeamProject, Error<TeamsSlashCheckPermissionsForProjectInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCheckPermissionsForProjectInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_check_permissions_for_project_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    project_id: i32,
) -> Result<models::TeamProject, Error<TeamsSlashCheckPermissionsForProjectLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCheckPermissionsForProjectLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_check_permissions_for_repo_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    owner: &str,
    repo: &str,
) -> Result<models::TeamRepository, Error<TeamsSlashCheckPermissionsForRepoInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCheckPermissionsForRepoInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_check_permissions_for_repo_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    owner: &str,
    repo: &str,
) -> Result<models::TeamRepository, Error<TeamsSlashCheckPermissionsForRepoLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCheckPermissionsForRepoLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_create(
    configuration: &configuration::Configuration,
    org: &str,
    teams_create_request: models::TeamsCreateRequest,
) -> Result<models::TeamFull, Error<TeamsSlashCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_create_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    teams_create_discussion_comment_in_org_request: models::TeamsCreateDiscussionCommentInOrgRequest,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashCreateDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&teams_create_discussion_comment_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCreateDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_create_discussion_comment_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    teams_create_discussion_comment_in_org_request: models::TeamsCreateDiscussionCommentInOrgRequest,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashCreateDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCreateDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_create_discussion_in_org(
    ...
    org: &str,
    team_slug: &str,
    teams_create_discussion_in_org_request: models::TeamsCreateDiscussionInOrgRequest,
) -> Result<models::TeamDiscussion, Error<TeamsSlashCreateDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCreateDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_create_discussion_legacy(
    ...
    team_id: i32,
    teams_create_discussion_in_org_request: models::TeamsCreateDiscussionInOrgRequest,
) -> Result<models::TeamDiscussion, Error<TeamsSlashCreateDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashCreateDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    comment_number: i32,
) -> Result<(), Error<TeamsSlashDeleteDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_discussion_comment_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    comment_number: i32,
) -> Result<(), Error<TeamsSlashDeleteDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_discussion_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
) -> Result<(), Error<TeamsSlashDeleteDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_discussion_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
) -> Result<(), Error<TeamsSlashDeleteDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
) -> Result<(), Error<TeamsSlashDeleteInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_delete_legacy(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashDeleteLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_by_name(
    ...
    org: &str,
    team_slug: &str,
) -> Result<models::TeamFull, Error<TeamsSlashGetByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    comment_number: i32,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashGetDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_discussion_comment_legacy(
    ...
    discussion_number: i32,
    comment_number: i32,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashGetDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_discussion_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
) -> Result<models::TeamDiscussion, Error<TeamsSlashGetDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_discussion_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
) -> Result<models::TeamDiscussion, Error<TeamsSlashGetDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
) -> Result<models::TeamFull, Error<TeamsSlashGetLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_member_legacy(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetMemberLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_membership_for_user_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    username: &str,
) -> Result<models::TeamMembership, Error<TeamsSlashGetMembershipForUserInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetMembershipForUserInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_get_membership_for_user_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    username: &str,
) -> Result<models::TeamMembership, Error<TeamsSlashGetMembershipForUserLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashGetMembershipForUserLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Team>, Error<TeamsSlashListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_child_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Team>, Error<TeamsSlashListChildInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListChildInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_child_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Team>, Error<TeamsSlashListChildLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListChildLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_discussion_comments_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamDiscussionComment>, Error<TeamsSlashListDiscussionCommentsInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListDiscussionCommentsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_discussion_comments_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    direction: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamDiscussionComment>, Error<TeamsSlashListDiscussionCommentsLegacyError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListDiscussionCommentsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_discussions_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    direction: Option<&str>,
    ...
    page: Option<i32>,
    pinned: Option<&str>,
) -> Result<Vec<models::TeamDiscussion>, Error<TeamsSlashListDiscussionsInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = pinned {
        local_var_req_builder =
            local_var_req_builder.query(&[("pinned", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListDiscussionsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_discussions_legacy(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamDiscussion>, Error<TeamsSlashListDiscussionsLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListDiscussionsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamFull>, Error<TeamsSlashListForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_members_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    role: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<TeamsSlashListMembersInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListMembersInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_members_legacy(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<TeamsSlashListMembersLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListMembersLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_pending_invitations_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrganizationInvitation>, Error<TeamsSlashListPendingInvitationsInOrgError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListPendingInvitationsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_pending_invitations_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrganizationInvitation>, Error<TeamsSlashListPendingInvitationsLegacyError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListPendingInvitationsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_projects_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamProject>, Error<TeamsSlashListProjectsInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListProjectsInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_projects_legacy(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamProject>, Error<TeamsSlashListProjectsLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListProjectsLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_repos_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<TeamsSlashListReposInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListReposInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_list_repos_legacy(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<TeamsSlashListReposLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashListReposLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_member_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    username: &str,
) -> Result<(), Error<TeamsSlashRemoveMemberLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveMemberLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_membership_for_user_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    username: &str,
) -> Result<(), Error<TeamsSlashRemoveMembershipForUserInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveMembershipForUserInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_membership_for_user_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    username: &str,
) -> Result<(), Error<TeamsSlashRemoveMembershipForUserLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveMembershipForUserLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_project_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    project_id: i32,
) -> Result<(), Error<TeamsSlashRemoveProjectInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveProjectInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_project_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    project_id: i32,
) -> Result<(), Error<TeamsSlashRemoveProjectLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveProjectLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_repo_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    owner: &str,
    repo: &str,
) -> Result<(), Error<TeamsSlashRemoveRepoInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveRepoInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_remove_repo_legacy(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashRemoveRepoLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    comment_number: i32,
    teams_create_discussion_comment_in_org_request: models::TeamsCreateDiscussionCommentInOrgRequest,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashUpdateDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_discussion_comment_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    comment_number: i32,
    teams_create_discussion_comment_in_org_request: models::TeamsCreateDiscussionCommentInOrgRequest,
) -> Result<models::TeamDiscussionComment, Error<TeamsSlashUpdateDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_discussion_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    teams_update_discussion_in_org_request: Option<models::TeamsUpdateDiscussionInOrgRequest>,
) -> Result<models::TeamDiscussion, Error<TeamsSlashUpdateDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_discussion_legacy(
    ...
    discussion_number: i32,
    teams_update_discussion_in_org_request: Option<models::TeamsUpdateDiscussionInOrgRequest>,
) -> Result<models::TeamDiscussion, Error<TeamsSlashUpdateDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_in_org(
    ...
    org: &str,
    team_slug: &str,
    teams_update_in_org_request: Option<models::TeamsUpdateInOrgRequest>,
) -> Result<models::TeamFull, Error<TeamsSlashUpdateInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn teams_slash_update_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    teams_update_legacy_request: models::TeamsUpdateLegacyRequest,
) -> Result<models::TeamFull, Error<TeamsSlashUpdateLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamsSlashUpdateLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
