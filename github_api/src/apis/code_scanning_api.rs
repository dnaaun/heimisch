...
pub async fn code_scanning_slash_create_variant_analysis(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    code_scanning_create_variant_analysis_request: Option<
        models::CodeScanningCreateVariantAnalysisRequest,
    >,
) -> Result<models::CodeScanningVariantAnalysis, Error<CodeScanningSlashCreateVariantAnalysisError>>
{
    ...
    local_var_req_builder =
        local_var_req_builder.json(&code_scanning_create_variant_analysis_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashCreateVariantAnalysisError> =
...
pub async fn code_scanning_slash_delete_analysis(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    analysis_id: i32,
    confirm_delete: Option<&str>,
) -> Result<models::CodeScanningAnalysisDeletion, Error<CodeScanningSlashDeleteAnalysisError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = confirm_delete {
        local_var_req_builder =
            local_var_req_builder.query(&[("confirm_delete", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashDeleteAnalysisError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_delete_codeql_database(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    language: &str,
) -> Result<(), Error<CodeScanningSlashDeleteCodeqlDatabaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashDeleteCodeqlDatabaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_alert(
    ...
    repo: &str,
    alert_number: i32,
) -> Result<models::CodeScanningAlert, Error<CodeScanningSlashGetAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_analysis(
    ...
    repo: &str,
    analysis_id: i32,
) -> Result<models::CodeScanningAnalysis, Error<CodeScanningSlashGetAnalysisError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetAnalysisError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_codeql_database(
    ...
    repo: &str,
    language: &str,
) -> Result<models::CodeScanningCodeqlDatabase, Error<CodeScanningSlashGetCodeqlDatabaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetCodeqlDatabaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_default_setup(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::CodeScanningDefaultSetup, Error<CodeScanningSlashGetDefaultSetupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetDefaultSetupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_sarif(
    ...
    repo: &str,
    sarif_id: &str,
) -> Result<models::CodeScanningSarifsStatus, Error<CodeScanningSlashGetSarifError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        sarif_id = crate::apis::urlencode(sarif_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetSarifError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_variant_analysis(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    codeql_variant_analysis_id: i32,
) -> Result<models::CodeScanningVariantAnalysis, Error<CodeScanningSlashGetVariantAnalysisError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetVariantAnalysisError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_get_variant_analysis_repo_task(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    codeql_variant_analysis_id: i32,
    ...
    models::CodeScanningVariantAnalysisRepoTask,
    Error<CodeScanningSlashGetVariantAnalysisRepoTaskError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashGetVariantAnalysisRepoTaskError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_list_alert_instances(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    alert_number: i32,
    ...
    r#ref: Option<&str>,
    pr: Option<i32>,
) -> Result<Vec<models::CodeScanningAlertInstance>, Error<CodeScanningSlashListAlertInstancesError>>
{
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = pr {
        local_var_req_builder = local_var_req_builder.query(&[("pr", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashListAlertInstancesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_list_alerts_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    tool_name: Option<&str>,
    tool_guid: Option<&str>,
    before: Option<&str>,
    after: Option<&str>,
    page: Option<i32>,
    per_page: Option<i32>,
    direction: Option<&str>,
    state: Option<models::CodeScanningAlertStateQuery>,
    sort: Option<&str>,
    severity: Option<models::CodeScanningAlertSeverity>,
) -> Result<
    Vec<models::CodeScanningOrganizationAlertItems>,
...
> {
    ...
    if let Some(ref local_var_str) = tool_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("tool_name", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = tool_guid {
        local_var_req_builder =
            local_var_req_builder.query(&[("tool_guid", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashListAlertsForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_list_alerts_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    tool_name: Option<&str>,
    ...
    state: Option<models::CodeScanningAlertStateQuery>,
    severity: Option<models::CodeScanningAlertSeverity>,
) -> Result<Vec<models::CodeScanningAlertItems>, Error<CodeScanningSlashListAlertsForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashListAlertsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_list_codeql_databases(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<models::CodeScanningCodeqlDatabase>, Error<CodeScanningSlashListCodeqlDatabasesError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashListCodeqlDatabasesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_list_recent_analyses(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    tool_name: Option<&str>,
    ...
    direction: Option<&str>,
    sort: Option<&str>,
) -> Result<Vec<models::CodeScanningAnalysis>, Error<CodeScanningSlashListRecentAnalysesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = sarif_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("sarif_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = direction {
        local_var_req_builder =
            local_var_req_builder.query(&[("direction", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashListRecentAnalysesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_update_alert(
    ...
    repo: &str,
    alert_number: i32,
    code_scanning_update_alert_request: models::CodeScanningUpdateAlertRequest,
) -> Result<models::CodeScanningAlert, Error<CodeScanningSlashUpdateAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashUpdateAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_update_default_setup(
    ...
    owner: &str,
    repo: &str,
    code_scanning_default_setup_update: models::CodeScanningDefaultSetupUpdate,
) -> Result<serde_json::Value, Error<CodeScanningSlashUpdateDefaultSetupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashUpdateDefaultSetupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn code_scanning_slash_upload_sarif(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    code_scanning_upload_sarif_request: models::CodeScanningUploadSarifRequest,
) -> Result<models::CodeScanningSarifsReceipt, Error<CodeScanningSlashUploadSarifError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodeScanningSlashUploadSarifError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
