...
pub async fn dependabot_slash_add_selected_repo_to_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<DependabotSlashAddSelectedRepoToOrgSecretError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashAddSelectedRepoToOrgSecretError> =
...
pub async fn dependabot_slash_create_or_update_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    dependabot_create_or_update_org_secret_request: models::DependabotCreateOrUpdateOrgSecretRequest,
) -> Result<serde_json::Value, Error<DependabotSlashCreateOrUpdateOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&dependabot_create_or_update_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashCreateOrUpdateOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_create_or_update_repo_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_name: &str,
    dependabot_create_or_update_repo_secret_request: models::DependabotCreateOrUpdateRepoSecretRequest,
) -> Result<serde_json::Value, Error<DependabotSlashCreateOrUpdateRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&dependabot_create_or_update_repo_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashCreateOrUpdateRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_delete_org_secret(
    ...
    org: &str,
    secret_name: &str,
) -> Result<(), Error<DependabotSlashDeleteOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashDeleteOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_delete_repo_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_name: &str,
) -> Result<(), Error<DependabotSlashDeleteRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashDeleteRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_get_alert(
    ...
    repo: &str,
    alert_number: i32,
) -> Result<models::DependabotAlert, Error<DependabotSlashGetAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashGetAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_get_org_public_key(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::DependabotPublicKey, Error<DependabotSlashGetOrgPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashGetOrgPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_get_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
) -> Result<models::OrganizationDependabotSecret, Error<DependabotSlashGetOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashGetOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_get_repo_public_key(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::DependabotPublicKey, Error<DependabotSlashGetRepoPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashGetRepoPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_get_repo_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_name: &str,
) -> Result<models::DependabotSecret, Error<DependabotSlashGetRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashGetRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_list_alerts_for_enterprise(
    configuration: &configuration::Configuration,
    enterprise: &str,
    state: Option<&str>,
    severity: Option<&str>,
    ...
    Vec<models::DependabotAlertWithRepository>,
    Error<DependabotSlashListAlertsForEnterpriseError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = package {
        local_var_req_builder =
            local_var_req_builder.query(&[("package", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = last {
        local_var_req_builder =
            local_var_req_builder.query(&[("last", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListAlertsForEnterpriseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_list_alerts_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    state: Option<&str>,
    severity: Option<&str>,
    ...
    last: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::DependabotAlertWithRepository>, Error<DependabotSlashListAlertsForOrgError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListAlertsForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// OAuth app tokens and personal access tokens (classic) need the `security_events` scope to use this endpoint. If this endpoint is only used with public repositories, the token can use the `public_repo` scope instead.
pub async fn dependabot_slash_list_alerts_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    state: Option<&str>,
    ...
    first: Option<i32>,
    last: Option<i32>,
) -> Result<Vec<models::DependabotAlert>, Error<DependabotSlashListAlertsForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = manifest {
        local_var_req_builder =
            local_var_req_builder.query(&[("manifest", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = scope {
        local_var_req_builder =
            local_var_req_builder.query(&[("scope", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListAlertsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_list_org_secrets(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DependabotListOrgSecrets200Response, Error<DependabotSlashListOrgSecretsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListOrgSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_list_repo_secrets(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::DependabotListRepoSecrets200Response, Error<DependabotSlashListRepoSecretsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListRepoSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_list_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    page: Option<i32>,
    ...
    Error<DependabotSlashListSelectedReposForOrgSecretError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashListSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_remove_selected_repo_from_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<DependabotSlashRemoveSelectedRepoFromOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashRemoveSelectedRepoFromOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_set_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    dependabot_set_selected_repos_for_org_secret_request: models::DependabotSetSelectedReposForOrgSecretRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&dependabot_set_selected_repos_for_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashSetSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependabot_slash_update_alert(
    ...
    repo: &str,
    alert_number: i32,
    dependabot_update_alert_request: models::DependabotUpdateAlertRequest,
) -> Result<models::DependabotAlert, Error<DependabotSlashUpdateAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependabotSlashUpdateAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
