...
pub async fn activity_slash_check_repo_is_starred_by_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<(), Error<ActivitySlashCheckRepoIsStarredByAuthenticatedUserError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashCheckRepoIsStarredByAuthenticatedUserError> =
...
pub async fn activity_slash_delete_repo_subscription(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashDeleteRepoSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_delete_thread_subscription(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashDeleteThreadSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_get_feeds(
    configuration: &configuration::Configuration,
) -> Result<models::Feed, Error<ActivitySlashGetFeedsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashGetFeedsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_get_repo_subscription(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::RepositorySubscription, Error<ActivitySlashGetRepoSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashGetRepoSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_get_thread(
    configuration: &configuration::Configuration,
    thread_id: i32,
) -> Result<models::Thread, Error<ActivitySlashGetThreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashGetThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_get_thread_subscription_for_authenticated_user(
    configuration: &configuration::Configuration,
    thread_id: i32,
) -> Result<
    models::ThreadSubscription,
    Error<ActivitySlashGetThreadSubscriptionForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashGetThreadSubscriptionForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_events_for_authenticated_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListEventsForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListEventsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_notifications_for_authenticated_user(
    configuration: &configuration::Configuration,
    all: Option<bool>,
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Thread>, Error<ActivitySlashListNotificationsForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = participating {
        local_var_req_builder =
            local_var_req_builder.query(&[("participating", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListNotificationsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_org_events_for_authenticated_user(
    configuration: &configuration::Configuration,
    username: &str,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListOrgEventsForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListOrgEventsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_public_events(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListPublicEventsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListPublicEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// > [!NOTE] > This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
pub async fn activity_slash_list_public_events_for_repo_network(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListPublicEventsForRepoNetworkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListPublicEventsForRepoNetworkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// > [!NOTE] > This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
pub async fn activity_slash_list_public_events_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListPublicEventsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListPublicEventsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// > [!NOTE] > This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
pub async fn activity_slash_list_public_org_events(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListPublicOrgEventsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListPublicOrgEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_received_events_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListReceivedEventsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListReceivedEventsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// > [!NOTE] > This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
pub async fn activity_slash_list_received_public_events_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListReceivedPublicEventsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListReceivedPublicEventsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_repo_events(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Event>, Error<ActivitySlashListRepoEventsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListRepoEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_repo_notifications_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    all: Option<bool>,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Thread>, Error<ActivitySlashListRepoNotificationsForAuthenticatedUserError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListRepoNotificationsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_repos_starred_by_authenticated_user(
    configuration: &configuration::Configuration,
    sort: Option<&str>,
    direction: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Repository>, Error<ActivitySlashListReposStarredByAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListReposStarredByAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_repos_starred_by_user(
    configuration: &configuration::Configuration,
    username: &str,
    sort: Option<&str>,
    direction: Option<&str>,
    ...
    Error<ActivitySlashListReposStarredByUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListReposStarredByUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_repos_watched_by_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<ActivitySlashListReposWatchedByUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListReposWatchedByUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_stargazers_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::ActivityListStargazersForRepo200Response,
    Error<ActivitySlashListStargazersForRepoError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListStargazersForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_watched_repos_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    Vec<models::MinimalRepository>,
    Error<ActivitySlashListWatchedReposForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListWatchedReposForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_list_watchers_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<ActivitySlashListWatchersForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashListWatchersForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_mark_notifications_as_read(
    configuration: &configuration::Configuration,
    activity_mark_notifications_as_read_request: Option<
        models::ActivityMarkNotificationsAsReadRequest,
    >,
) -> Result<
    models::ActivityMarkNotificationsAsRead202Response,
    Error<ActivitySlashMarkNotificationsAsReadError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&activity_mark_notifications_as_read_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashMarkNotificationsAsReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_mark_repo_notifications_as_read(
    ...
    owner: &str,
    repo: &str,
    activity_mark_repo_notifications_as_read_request: Option<
        models::ActivityMarkRepoNotificationsAsReadRequest,
    >,
) -> Result<
    models::ActivityMarkRepoNotificationsAsRead202Response,
    Error<ActivitySlashMarkRepoNotificationsAsReadError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&activity_mark_repo_notifications_as_read_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashMarkRepoNotificationsAsReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_mark_thread_as_done(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashMarkThreadAsDoneError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_mark_thread_as_read(
    configuration: &configuration::Configuration,
    thread_id: i32,
) -> Result<(), Error<ActivitySlashMarkThreadAsReadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashMarkThreadAsReadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_set_repo_subscription(
    ...
    owner: &str,
    repo: &str,
    activity_set_repo_subscription_request: Option<models::ActivitySetRepoSubscriptionRequest>,
) -> Result<models::RepositorySubscription, Error<ActivitySlashSetRepoSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashSetRepoSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_set_thread_subscription(
    configuration: &configuration::Configuration,
    thread_id: i32,
    activity_set_thread_subscription_request: Option<models::ActivitySetThreadSubscriptionRequest>,
) -> Result<models::ThreadSubscription, Error<ActivitySlashSetThreadSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashSetThreadSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_star_repo_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<(), Error<ActivitySlashStarRepoForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashStarRepoForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn activity_slash_unstar_repo_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<(), Error<ActivitySlashUnstarRepoForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ActivitySlashUnstarRepoForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
