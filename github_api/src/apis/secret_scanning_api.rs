...
pub async fn secret_scanning_slash_create_push_protection_bypass(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_scanning_create_push_protection_bypass_request: models::SecretScanningCreatePushProtectionBypassRequest,
) -> Result<
    models::SecretScanningPushProtectionBypass,
...
> {
    ...
    local_var_req_builder =
        local_var_req_builder.json(&secret_scanning_create_push_protection_bypass_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashCreatePushProtectionBypassError> =
...
pub async fn secret_scanning_slash_get_alert(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    alert_number: i32,
) -> Result<models::SecretScanningAlert, Error<SecretScanningSlashGetAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashGetAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn secret_scanning_slash_list_alerts_for_enterprise(
    configuration: &configuration::Configuration,
    enterprise: &str,
    state: Option<&str>,
    ...
    Vec<models::OrganizationSecretScanningAlert>,
    Error<SecretScanningSlashListAlertsForEnterpriseError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = secret_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("secret_type", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = validity {
        local_var_req_builder =
            local_var_req_builder.query(&[("validity", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_publicly_leaked {
        local_var_req_builder =
            local_var_req_builder.query(&[("is_publicly_leaked", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = is_multi_repo {
        local_var_req_builder =
            local_var_req_builder.query(&[("is_multi_repo", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashListAlertsForEnterpriseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn secret_scanning_slash_list_alerts_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    state: Option<&str>,
    secret_type: Option<&str>,
    ...
    Vec<models::OrganizationSecretScanningAlert>,
    Error<SecretScanningSlashListAlertsForOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashListAlertsForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn secret_scanning_slash_list_alerts_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    state: Option<&str>,
    ...
    is_publicly_leaked: Option<bool>,
    is_multi_repo: Option<bool>,
) -> Result<Vec<models::SecretScanningAlert>, Error<SecretScanningSlashListAlertsForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashListAlertsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn secret_scanning_slash_list_locations_for_alert(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    alert_number: i32,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::SecretScanningLocation>, Error<SecretScanningSlashListLocationsForAlertError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashListLocationsForAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn secret_scanning_slash_update_alert(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    alert_number: i32,
    secret_scanning_update_alert_request: models::SecretScanningUpdateAlertRequest,
) -> Result<models::SecretScanningAlert, Error<SecretScanningSlashUpdateAlertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SecretScanningSlashUpdateAlertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
