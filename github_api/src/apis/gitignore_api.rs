...
pub async fn gitignore_slash_get_all_templates(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitignoreSlashGetAllTemplatesError> =
...
pub async fn gitignore_slash_get_template(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<models::GitignoreTemplate, Error<GitignoreSlashGetTemplateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitignoreSlashGetTemplateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
