...
pub async fn dependency_graph_slash_create_repository_snapshot(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    snapshot: models::Snapshot,
) -> Result<
    models::DependencyGraphCreateRepositorySnapshot201Response,
    Error<DependencyGraphSlashCreateRepositorySnapshotError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependencyGraphSlashCreateRepositorySnapshotError> =
...
pub async fn dependency_graph_slash_diff_range(
    ...
    basehead: &str,
    name: Option<&str>,
) -> Result<Vec<models::DependencyGraphDiffInner>, Error<DependencyGraphSlashDiffRangeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependencyGraphSlashDiffRangeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn dependency_graph_slash_export_sbom(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::DependencyGraphSpdxSbom, Error<DependencyGraphSlashExportSbomError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DependencyGraphSlashExportSbomError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
