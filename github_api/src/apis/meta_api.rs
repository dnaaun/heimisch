...
pub async fn meta_slash_get(
    configuration: &configuration::Configuration,
) -> Result<models::ApiOverview, Error<MetaSlashGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetaSlashGetError> =
...
pub async fn meta_slash_get_all_versions(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<MetaSlashGetAllVersionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetaSlashGetAllVersionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn meta_slash_get_octocat(
    configuration: &configuration::Configuration,
    s: Option<&str>,
) -> Result<String, Error<MetaSlashGetOctocatError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetaSlashGetOctocatError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn meta_slash_get_zen(
    configuration: &configuration::Configuration,
) -> Result<String, Error<MetaSlashGetZenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetaSlashGetZenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn meta_slash_root(
    configuration: &configuration::Configuration,
) -> Result<models::Root, Error<MetaSlashRootError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MetaSlashRootError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
