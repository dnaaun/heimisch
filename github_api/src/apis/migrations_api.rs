...
pub async fn migrations_slash_cancel_import(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<(), Error<MigrationsSlashCancelImportError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashCancelImportError> =
...
pub async fn migrations_slash_delete_archive_for_authenticated_user(
    configuration: &configuration::Configuration,
    migration_id: i32,
) -> Result<(), Error<MigrationsSlashDeleteArchiveForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashDeleteArchiveForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_delete_archive_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migration_id: i32,
) -> Result<(), Error<MigrationsSlashDeleteArchiveForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashDeleteArchiveForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_download_archive_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migration_id: i32,
) -> Result<(), Error<MigrationsSlashDownloadArchiveForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashDownloadArchiveForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_archive_for_authenticated_user(
    configuration: &configuration::Configuration,
    migration_id: i32,
) -> Result<(), Error<MigrationsSlashGetArchiveForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetArchiveForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_commit_authors(
    ...
    repo: &str,
    since: Option<i32>,
) -> Result<Vec<models::PorterAuthor>, Error<MigrationsSlashGetCommitAuthorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetCommitAuthorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_import_status(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::Import, Error<MigrationsSlashGetImportStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetImportStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_large_files(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<models::PorterLargeFile>, Error<MigrationsSlashGetLargeFilesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetLargeFilesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_status_for_authenticated_user(
    configuration: &configuration::Configuration,
    migration_id: i32,
    exclude: Option<Vec<String>>,
) -> Result<models::Migration, Error<MigrationsSlashGetStatusForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetStatusForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_get_status_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migration_id: i32,
    exclude: Option<Vec<String>>,
) -> Result<models::Migration, Error<MigrationsSlashGetStatusForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashGetStatusForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_list_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Migration>, Error<MigrationsSlashListForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashListForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_list_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    exclude: Option<Vec<String>>,
) -> Result<Vec<models::Migration>, Error<MigrationsSlashListForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashListForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_list_repos_for_authenticated_user(
    configuration: &configuration::Configuration,
    migration_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<MigrationsSlashListReposForAuthenticatedUserError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashListReposForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_list_repos_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migration_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<MigrationsSlashListReposForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashListReposForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_map_commit_author(
    ...
    repo: &str,
    author_id: i32,
    migrations_map_commit_author_request: Option<models::MigrationsMapCommitAuthorRequest>,
) -> Result<models::PorterAuthor, Error<MigrationsSlashMapCommitAuthorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashMapCommitAuthorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_set_lfs_preference(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    migrations_set_lfs_preference_request: models::MigrationsSetLfsPreferenceRequest,
) -> Result<models::Import, Error<MigrationsSlashSetLfsPreferenceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashSetLfsPreferenceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_start_for_authenticated_user(
    configuration: &configuration::Configuration,
    migrations_start_for_authenticated_user_request: models::MigrationsStartForAuthenticatedUserRequest,
) -> Result<models::Migration, Error<MigrationsSlashStartForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&migrations_start_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashStartForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_start_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migrations_start_for_org_request: models::MigrationsStartForOrgRequest,
) -> Result<models::Migration, Error<MigrationsSlashStartForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashStartForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_start_import(
    ...
    owner: &str,
    repo: &str,
    migrations_start_import_request: models::MigrationsStartImportRequest,
) -> Result<models::Import, Error<MigrationsSlashStartImportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashStartImportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_unlock_repo_for_authenticated_user(
    configuration: &configuration::Configuration,
    migration_id: i32,
    repo_name: &str,
) -> Result<(), Error<MigrationsSlashUnlockRepoForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        migration_id = migration_id,
        repo_name = crate::apis::urlencode(repo_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashUnlockRepoForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_unlock_repo_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    migration_id: i32,
    repo_name: &str,
) -> Result<(), Error<MigrationsSlashUnlockRepoForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashUnlockRepoForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrations_slash_update_import(
    ...
    owner: &str,
    repo: &str,
    migrations_update_import_request: Option<models::MigrationsUpdateImportRequest>,
) -> Result<models::Import, Error<MigrationsSlashUpdateImportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrationsSlashUpdateImportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
