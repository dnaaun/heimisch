...
pub async fn reactions_slash_create_for_commit_comment(
    ...
    repo: &str,
    comment_id: i64,
    reactions_create_for_commit_comment_request: models::ReactionsCreateForCommitCommentRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForCommitCommentError>> {
    ...
    local_var_req_builder =
        local_var_req_builder.json(&reactions_create_for_commit_comment_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForCommitCommentError> =
...
pub async fn reactions_slash_create_for_issue(
    ...
    repo: &str,
    issue_number: i32,
    reactions_create_for_issue_request: models::ReactionsCreateForIssueRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_issue_comment(
    ...
    repo: &str,
    comment_id: i64,
    reactions_create_for_issue_comment_request: models::ReactionsCreateForIssueCommentRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForIssueCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForIssueCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_pull_request_review_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    reactions_create_for_pull_request_review_comment_request: models::ReactionsCreateForPullRequestReviewCommentRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&reactions_create_for_pull_request_review_comment_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForPullRequestReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_release(
    ...
    repo: &str,
    release_id: i32,
    reactions_create_for_release_request: models::ReactionsCreateForReleaseRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_team_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    comment_number: i32,
    reactions_create_for_team_discussion_comment_in_org_request: models::ReactionsCreateForTeamDiscussionCommentInOrgRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForTeamDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&reactions_create_for_team_discussion_comment_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForTeamDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_team_discussion_comment_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    comment_number: i32,
    reactions_create_for_team_discussion_comment_in_org_request: models::ReactionsCreateForTeamDiscussionCommentInOrgRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForTeamDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForTeamDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_team_discussion_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    reactions_create_for_team_discussion_in_org_request: models::ReactionsCreateForTeamDiscussionInOrgRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForTeamDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&reactions_create_for_team_discussion_in_org_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForTeamDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_create_for_team_discussion_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    reactions_create_for_team_discussion_in_org_request: models::ReactionsCreateForTeamDiscussionInOrgRequest,
) -> Result<models::Reaction, Error<ReactionsSlashCreateForTeamDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashCreateForTeamDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_commit_comment(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForCommitCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_issue(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    issue_number: i32,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_issue_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForIssueCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForIssueCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_pull_request_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForPullRequestCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForPullRequestCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_release(
    ...
    release_id: i32,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_team_discussion(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForTeamDiscussionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForTeamDiscussionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_delete_for_team_discussion_comment(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    comment_number: i32,
    reaction_id: i32,
) -> Result<(), Error<ReactionsSlashDeleteForTeamDiscussionCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashDeleteForTeamDiscussionCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_commit_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForCommitCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForCommitCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_issue(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    issue_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForIssueError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForIssueError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_issue_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForIssueCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForIssueCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_pull_request_review_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForPullRequestReviewCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForPullRequestReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_release(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    release_id: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_team_discussion_comment_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForTeamDiscussionCommentInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForTeamDiscussionCommentInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_team_discussion_comment_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    comment_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForTeamDiscussionCommentLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForTeamDiscussionCommentLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_team_discussion_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    discussion_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForTeamDiscussionInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForTeamDiscussionInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reactions_slash_list_for_team_discussion_legacy(
    configuration: &configuration::Configuration,
    team_id: i32,
    discussion_number: i32,
    content: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Reaction>, Error<ReactionsSlashListForTeamDiscussionLegacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReactionsSlashListForTeamDiscussionLegacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
