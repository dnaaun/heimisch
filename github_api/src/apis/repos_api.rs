...
///
pub async fn repos_slash_accept_invitation_for_authenticated_user(
    configuration: &configuration::Configuration,
    invitation_id: i32,
) -> Result<(), Error<ReposSlashAcceptInvitationForAuthenticatedUserError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAcceptInvitationForAuthenticatedUserError> =
...
pub async fn repos_slash_add_app_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_app_access_restrictions_request: models::ReposSetAppAccessRestrictionsRequest,
) -> Result<Vec<models::Integration>, Error<ReposSlashAddAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAddAppAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_add_collaborator(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    username: &str,
    repos_add_collaborator_request: Option<models::ReposAddCollaboratorRequest>,
) -> Result<models::RepositoryInvitation, Error<ReposSlashAddCollaboratorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAddCollaboratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_add_status_check_contexts(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_status_check_contexts_request: Option<models::ReposSetStatusCheckContextsRequest>,
) -> Result<Vec<String>, Error<ReposSlashAddStatusCheckContextsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAddStatusCheckContextsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_add_team_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_add_team_access_restrictions_request: Option<
        models::ReposAddTeamAccessRestrictionsRequest,
    >,
) -> Result<Vec<models::Team>, Error<ReposSlashAddTeamAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAddTeamAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_add_user_access_restrictions(
    ...
    repo: &str,
    branch: &str,
    repos_set_user_access_restrictions_request: models::ReposSetUserAccessRestrictionsRequest,
) -> Result<Vec<models::SimpleUser>, Error<ReposSlashAddUserAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashAddUserAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_cancel_pages_deployment(
    ...
    owner: &str,
    repo: &str,
    pages_deployment_id: models::ActionsGetWorkflowWorkflowIdParameter,
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        pages_deployment_id = pages_deployment_id.to_string()
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCancelPagesDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_check_automated_security_fixes(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::CheckAutomatedSecurityFixes, Error<ReposSlashCheckAutomatedSecurityFixesError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCheckAutomatedSecurityFixesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_check_collaborator(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    username: &str,
) -> Result<(), Error<ReposSlashCheckCollaboratorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCheckCollaboratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_check_private_vulnerability_reporting(
    ...
    models::ReposCheckPrivateVulnerabilityReporting200Response,
    Error<ReposSlashCheckPrivateVulnerabilityReportingError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCheckPrivateVulnerabilityReportingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_check_vulnerability_alerts(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCheckVulnerabilityAlertsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_codeowners_errors(
    ...
    repo: &str,
    r#ref: Option<&str>,
) -> Result<models::CodeownersErrors, Error<ReposSlashCodeownersErrorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCodeownersErrorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_compare_commits(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    basehead: &str,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::CommitComparison, Error<ReposSlashCompareCommitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCompareCommitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_attestation(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_create_attestation_request: models::ReposCreateAttestationRequest,
) -> Result<models::ReposCreateAttestation201Response, Error<ReposSlashCreateAttestationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateAttestationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_autolink(
    ...
    owner: &str,
    repo: &str,
    repos_create_autolink_request: models::ReposCreateAutolinkRequest,
) -> Result<models::Autolink, Error<ReposSlashCreateAutolinkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateAutolinkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_commit_comment(
    ...
    repo: &str,
    commit_sha: &str,
    repos_create_commit_comment_request: models::ReposCreateCommitCommentRequest,
...
pub async fn repos_slash_create_commit_signature_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<
    models::ProtectedBranchAdminEnforced,
    Error<ReposSlashCreateCommitSignatureProtectionError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateCommitSignatureProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_commit_status(
    ...
    repo: &str,
    sha: &str,
    repos_create_commit_status_request: models::ReposCreateCommitStatusRequest,
) -> Result<models::Status, Error<ReposSlashCreateCommitStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateCommitStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_deploy_key(
    ...
    owner: &str,
    repo: &str,
    repos_create_deploy_key_request: models::ReposCreateDeployKeyRequest,
) -> Result<models::DeployKey, Error<ReposSlashCreateDeployKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDeployKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_deployment(
    ...
    owner: &str,
    repo: &str,
    repos_create_deployment_request: models::ReposCreateDeploymentRequest,
) -> Result<models::Deployment, Error<ReposSlashCreateDeploymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_deployment_branch_policy(
    ...
    deployment_branch_policy_name_pattern_with_type: models::DeploymentBranchPolicyNamePatternWithType,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&deployment_branch_policy_name_pattern_with_type);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDeploymentBranchPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<models::DeploymentProtectionRule, Error<ReposSlashCreateDeploymentProtectionRuleError>>
{
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_create_deployment_protection_rule_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDeploymentProtectionRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_deployment_status(
    ...
    repo: &str,
    deployment_id: i32,
    repos_create_deployment_status_request: models::ReposCreateDeploymentStatusRequest,
) -> Result<models::DeploymentStatus, Error<ReposSlashCreateDeploymentStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDeploymentStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_dispatch_event(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_create_dispatch_event_request: models::ReposCreateDispatchEventRequest,
) -> Result<(), Error<ReposSlashCreateDispatchEventError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateDispatchEventError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_for_authenticated_user(
    configuration: &configuration::Configuration,
    repos_create_for_authenticated_user_request: models::ReposCreateForAuthenticatedUserRequest,
) -> Result<models::FullRepository, Error<ReposSlashCreateForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_create_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_fork(
    ...
    owner: &str,
    repo: &str,
    repos_create_fork_request: Option<models::ReposCreateForkRequest>,
) -> Result<models::FullRepository, Error<ReposSlashCreateForkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateForkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    repos_create_in_org_request: models::ReposCreateInOrgRequest,
) -> Result<models::FullRepository, Error<ReposSlashCreateInOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_or_update_custom_properties_values(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_create_or_update_custom_properties_values_request: models::ReposCreateOrUpdateCustomPropertiesValuesRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_create_or_update_custom_properties_values_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateOrUpdateCustomPropertiesValuesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_or_update_environment(
    ...
    repo: &str,
    environment_name: &str,
    repos_create_or_update_environment_request: Option<
        models::ReposCreateOrUpdateEnvironmentRequest,
    >,
) -> Result<models::Environment, Error<ReposSlashCreateOrUpdateEnvironmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateOrUpdateEnvironmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_or_update_file_contents(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    path: &str,
    repos_create_or_update_file_contents_request: models::ReposCreateOrUpdateFileContentsRequest,
) -> Result<models::FileCommit, Error<ReposSlashCreateOrUpdateFileContentsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_create_or_update_file_contents_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateOrUpdateFileContentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_org_ruleset(
    configuration: &configuration::Configuration,
    org: &str,
    repos_create_org_ruleset_request: models::ReposCreateOrgRulesetRequest,
) -> Result<models::RepositoryRuleset, Error<ReposSlashCreateOrgRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateOrgRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_pages_deployment(
    ...
    owner: &str,
    repo: &str,
    repos_create_pages_deployment_request: models::ReposCreatePagesDeploymentRequest,
) -> Result<models::PageDeployment, Error<ReposSlashCreatePagesDeploymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreatePagesDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_pages_site(
    ...
    owner: &str,
    repo: &str,
    repos_create_pages_site_request: Option<models::ReposCreatePagesSiteRequest>,
) -> Result<models::Page, Error<ReposSlashCreatePagesSiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreatePagesSiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_release(
    ...
    owner: &str,
    repo: &str,
    repos_create_release_request: models::ReposCreateReleaseRequest,
) -> Result<models::Release, Error<ReposSlashCreateReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_repo_ruleset(
    ...
    owner: &str,
    repo: &str,
    repos_create_repo_ruleset_request: models::ReposCreateRepoRulesetRequest,
) -> Result<models::RepositoryRuleset, Error<ReposSlashCreateRepoRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateRepoRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_tag_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_create_tag_protection_request: models::ReposCreateTagProtectionRequest,
) -> Result<models::TagProtection, Error<ReposSlashCreateTagProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateTagProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_using_template(
    ...
    template_owner: &str,
    template_repo: &str,
    repos_create_using_template_request: models::ReposCreateUsingTemplateRequest,
) -> Result<models::FullRepository, Error<ReposSlashCreateUsingTemplateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateUsingTemplateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_create_webhook(
    ...
    owner: &str,
    repo: &str,
    repos_create_webhook_request: Option<models::ReposCreateWebhookRequest>,
) -> Result<models::Hook, Error<ReposSlashCreateWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashCreateWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_decline_invitation_for_authenticated_user(
    configuration: &configuration::Configuration,
    invitation_id: i32,
) -> Result<(), Error<ReposSlashDeclineInvitationForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeclineInvitationForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashDeleteAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_admin_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashDeleteAdminBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteAdminBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_an_environment(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteAnEnvironmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_autolink(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteAutolinkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_delete_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashDeleteBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_commit_comment(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteCommitCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_commit_signature_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashDeleteCommitSignatureProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteCommitSignatureProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_deploy_key(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteDeployKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_deployment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    deployment_id: i32,
) -> Result<(), Error<ReposSlashDeleteDeploymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_deployment_branch_policy(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteDeploymentBranchPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_file(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    path: &str,
    repos_delete_file_request: models::ReposDeleteFileRequest,
) -> Result<models::FileCommit, Error<ReposSlashDeleteFileError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteFileError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_delete_invitation(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    invitation_id: i32,
) -> Result<(), Error<ReposSlashDeleteInvitationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteInvitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_org_ruleset(
    configuration: &configuration::Configuration,
    org: &str,
    ruleset_id: i32,
) -> Result<(), Error<ReposSlashDeleteOrgRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteOrgRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_pages_site(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeletePagesSiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_delete_pull_request_review_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashDeletePullRequestReviewProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeletePullRequestReviewProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_release(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_release_asset(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteReleaseAssetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_repo_ruleset(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteRepoRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_tag_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    tag_protection_id: i32,
) -> Result<(), Error<ReposSlashDeleteTagProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteTagProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_delete_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDeleteWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_disable_automated_security_fixes(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<(), Error<ReposSlashDisableAutomatedSecurityFixesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDisableAutomatedSecurityFixesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_disable_deployment_protection_rule(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDisableDeploymentProtectionRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_disable_private_vulnerability_reporting(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDisablePrivateVulnerabilityReportingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_disable_vulnerability_alerts(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDisableVulnerabilityAlertsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_download_tarball_archive(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: &str,
) -> Result<(), Error<ReposSlashDownloadTarballArchiveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDownloadTarballArchiveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_download_zipball_archive(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: &str,
) -> Result<(), Error<ReposSlashDownloadZipballArchiveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashDownloadZipballArchiveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_enable_automated_security_fixes(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashEnableAutomatedSecurityFixesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_enable_private_vulnerability_reporting(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashEnablePrivateVulnerabilityReportingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_enable_vulnerability_alerts(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashEnableVulnerabilityAlertsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_generate_release_notes(
    ...
    owner: &str,
    repo: &str,
    repos_generate_release_notes_request: models::ReposGenerateReleaseNotesRequest,
) -> Result<models::ReleaseNotesContent, Error<ReposSlashGenerateReleaseNotesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGenerateReleaseNotesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::FullRepository, Error<ReposSlashGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::BranchRestrictionPolicy, Error<ReposSlashGetAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_get_admin_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::ProtectedBranchAdminEnforced, Error<ReposSlashGetAdminBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAdminBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_all_deployment_protection_rules(
    ...
    models::ReposGetAllDeploymentProtectionRules200Response,
    Error<ReposSlashGetAllDeploymentProtectionRulesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAllDeploymentProtectionRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_all_environments(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ReposGetAllEnvironments200Response, Error<ReposSlashGetAllEnvironmentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAllEnvironmentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_get_all_status_check_contexts(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<Vec<String>, Error<ReposSlashGetAllStatusCheckContextsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAllStatusCheckContextsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_all_topics(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::Topic, Error<ReposSlashGetAllTopicsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAllTopicsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_apps_with_access_to_protected_branch(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<Vec<models::Integration>, Error<ReposSlashGetAppsWithAccessToProtectedBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAppsWithAccessToProtectedBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_autolink(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    autolink_id: i32,
) -> Result<models::Autolink, Error<ReposSlashGetAutolinkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetAutolinkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_branch(
    ...
    repo: &str,
    branch: &str,
) -> Result<models::BranchWithProtection, Error<ReposSlashGetBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_get_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::BranchProtection, Error<ReposSlashGetBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_branch_rules(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::RepositoryRuleDetailed>, Error<ReposSlashGetBranchRulesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetBranchRulesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_clones(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per: Option<&str>,
) -> Result<models::CloneTraffic, Error<ReposSlashGetClonesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetClonesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_code_frequency_stats(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<Vec<i32>>, Error<ReposSlashGetCodeFrequencyStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCodeFrequencyStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_collaborator_permission_level(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    username: &str,
) -> Result<
    models::RepositoryCollaboratorPermission,
    Error<ReposSlashGetCollaboratorPermissionLevelError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCollaboratorPermissionLevelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_combined_status_for_ref(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::CombinedCommitStatus, Error<ReposSlashGetCombinedStatusForRefError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCombinedStatusForRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_commit_activity_stats(
    ...
    owner: &str,
    repo: &str,
) -> Result<Vec<models::CommitActivity>, Error<ReposSlashGetCommitActivityStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCommitActivityStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_commit_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
) -> Result<models::CommitComment, Error<ReposSlashGetCommitCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCommitCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_commit_signature_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::ProtectedBranchAdminEnforced, Error<ReposSlashGetCommitSignatureProtectionError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCommitSignatureProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_community_profile_metrics(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::CommunityProfile, Error<ReposSlashGetCommunityProfileMetricsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCommunityProfileMetricsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_content(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    path: &str,
    r#ref: Option<&str>,
) -> Result<models::ContentTree, Error<ReposSlashGetContentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetContentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_contributors_stats(
    ...
    owner: &str,
    repo: &str,
) -> Result<Vec<models::ContributorActivity>, Error<ReposSlashGetContributorsStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetContributorsStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_custom_deployment_protection_rule(
    ...
    environment_name: &str,
    protection_rule_id: i32,
) -> Result<models::DeploymentProtectionRule, Error<ReposSlashGetCustomDeploymentProtectionRuleError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCustomDeploymentProtectionRuleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_custom_properties_values(
    ...
    owner: &str,
    repo: &str,
) -> Result<Vec<models::CustomPropertyValue>, Error<ReposSlashGetCustomPropertiesValuesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetCustomPropertiesValuesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_deploy_key(
    ...
    repo: &str,
    key_id: i32,
) -> Result<models::DeployKey, Error<ReposSlashGetDeployKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetDeployKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_deployment(
    ...
    repo: &str,
    deployment_id: i32,
) -> Result<models::Deployment, Error<ReposSlashGetDeploymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_deployment_branch_policy(
    ...
    environment_name: &str,
    branch_policy_id: i32,
) -> Result<models::DeploymentBranchPolicy, Error<ReposSlashGetDeploymentBranchPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetDeploymentBranchPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_deployment_status(
    ...
    deployment_id: i32,
    status_id: i32,
) -> Result<models::DeploymentStatus, Error<ReposSlashGetDeploymentStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetDeploymentStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_environment(
    ...
    repo: &str,
    environment_name: &str,
) -> Result<models::Environment, Error<ReposSlashGetEnvironmentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetEnvironmentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_latest_pages_build(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::PageBuild, Error<ReposSlashGetLatestPagesBuildError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetLatestPagesBuildError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_latest_release(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::Release, Error<ReposSlashGetLatestReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetLatestReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_org_rule_suite(
    ...
    org: &str,
    rule_suite_id: i32,
) -> Result<models::RuleSuite, Error<ReposSlashGetOrgRuleSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetOrgRuleSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_org_rule_suites(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::RuleSuitesInner>, Error<ReposSlashGetOrgRuleSuitesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = repository_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("repository_name", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = actor_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("actor_name", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = rule_suite_result {
        local_var_req_builder =
            local_var_req_builder.query(&[("rule_suite_result", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = per_page {
        local_var_req_builder =
            local_var_req_builder.query(&[("per_page", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetOrgRuleSuitesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_org_ruleset(
    configuration: &configuration::Configuration,
    org: &str,
    ruleset_id: i32,
) -> Result<models::RepositoryRuleset, Error<ReposSlashGetOrgRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetOrgRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_org_rulesets(
    ...
    page: Option<i32>,
    targets: Option<&str>,
) -> Result<Vec<models::RepositoryRuleset>, Error<ReposSlashGetOrgRulesetsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = targets {
        local_var_req_builder =
            local_var_req_builder.query(&[("targets", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetOrgRulesetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_pages(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::Page, Error<ReposSlashGetPagesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPagesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_pages_build(
    ...
    repo: &str,
    build_id: i32,
) -> Result<models::PageBuild, Error<ReposSlashGetPagesBuildError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPagesBuildError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_pages_deployment(
    ...
    repo: &str,
    pages_deployment_id: models::ActionsGetWorkflowWorkflowIdParameter,
) -> Result<models::PagesDeploymentStatus, Error<ReposSlashGetPagesDeploymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPagesDeploymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_pages_health_check(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::PagesHealthCheck, Error<ReposSlashGetPagesHealthCheckError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPagesHealthCheckError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_participation_stats(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::ParticipationStats, Error<ReposSlashGetParticipationStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetParticipationStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_get_pull_request_review_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<
    models::ProtectedBranchPullRequestReview,
    Error<ReposSlashGetPullRequestReviewProtectionError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPullRequestReviewProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_punch_card_stats(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetPunchCardStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_readme(
    ...
    repo: &str,
    r#ref: Option<&str>,
) -> Result<models::ContentFile, Error<ReposSlashGetReadmeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetReadmeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_readme_in_directory(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    dir: &str,
    r#ref: Option<&str>,
) -> Result<models::ContentFile, Error<ReposSlashGetReadmeInDirectoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetReadmeInDirectoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_release(
    ...
    repo: &str,
    release_id: i32,
) -> Result<models::Release, Error<ReposSlashGetReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_release_asset(
    ...
    repo: &str,
    asset_id: i32,
) -> Result<models::ReleaseAsset, Error<ReposSlashGetReleaseAssetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetReleaseAssetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_release_by_tag(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    tag: &str,
) -> Result<models::Release, Error<ReposSlashGetReleaseByTagError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetReleaseByTagError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_repo_rule_suite(
    ...
    repo: &str,
    rule_suite_id: i32,
) -> Result<models::RuleSuite, Error<ReposSlashGetRepoRuleSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetRepoRuleSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_repo_rule_suites(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::RuleSuitesInner>, Error<ReposSlashGetRepoRuleSuitesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetRepoRuleSuitesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_repo_ruleset(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    ruleset_id: i32,
    includes_parents: Option<bool>,
) -> Result<models::RepositoryRuleset, Error<ReposSlashGetRepoRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = includes_parents {
        local_var_req_builder =
            local_var_req_builder.query(&[("includes_parents", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetRepoRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_repo_rulesets(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    includes_parents: Option<bool>,
    targets: Option<&str>,
) -> Result<Vec<models::RepositoryRuleset>, Error<ReposSlashGetRepoRulesetsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetRepoRulesetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_get_status_checks_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::StatusCheckPolicy, Error<ReposSlashGetStatusChecksProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetStatusChecksProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_teams_with_access_to_protected_branch(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<Vec<models::Team>, Error<ReposSlashGetTeamsWithAccessToProtectedBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetTeamsWithAccessToProtectedBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_top_paths(
    ...
    owner: &str,
    repo: &str,
) -> Result<Vec<models::ContentTraffic>, Error<ReposSlashGetTopPathsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetTopPathsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_top_referrers(
    ...
    owner: &str,
    repo: &str,
) -> Result<Vec<models::ReferrerTraffic>, Error<ReposSlashGetTopReferrersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetTopReferrersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_users_with_access_to_protected_branch(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<Vec<models::SimpleUser>, Error<ReposSlashGetUsersWithAccessToProtectedBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetUsersWithAccessToProtectedBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_views(
    ...
    repo: &str,
    per: Option<&str>,
) -> Result<models::ViewTraffic, Error<ReposSlashGetViewsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetViewsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_webhook(
    ...
    repo: &str,
    hook_id: i32,
) -> Result<models::Hook, Error<ReposSlashGetWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_webhook_config_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    hook_id: i32,
) -> Result<models::WebhookConfig, Error<ReposSlashGetWebhookConfigForRepoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetWebhookConfigForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_get_webhook_delivery(
    ...
    hook_id: i32,
    delivery_id: i32,
) -> Result<models::HookDelivery, Error<ReposSlashGetWebhookDeliveryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashGetWebhookDeliveryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_activities(
...
) -> Result<Vec<models::Activity>, Error<ReposSlashListActivitiesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = actor {
        local_var_req_builder =
            local_var_req_builder.query(&[("actor", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = time_period {
        local_var_req_builder =
            local_var_req_builder.query(&[("time_period", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = activity_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("activity_type", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListActivitiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_attestations(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    subject_digest: &str,
    ...
    before: Option<&str>,
    after: Option<&str>,
) -> Result<models::OrgsListAttestations200Response, Error<ReposSlashListAttestationsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        subject_digest = crate::apis::urlencode(subject_digest)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListAttestationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_autolinks(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<models::Autolink>, Error<ReposSlashListAutolinksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListAutolinksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_branches(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::ShortBranch>, Error<ReposSlashListBranchesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = protected {
        local_var_req_builder =
            local_var_req_builder.query(&[("protected", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = per_page {
        local_var_req_builder =
            local_var_req_builder.query(&[("per_page", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListBranchesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_branches_for_head_commit(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    commit_sha: &str,
) -> Result<Vec<models::BranchShort>, Error<ReposSlashListBranchesForHeadCommitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListBranchesForHeadCommitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_collaborators(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Collaborator>, Error<ReposSlashListCollaboratorsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = permission {
        local_var_req_builder =
            local_var_req_builder.query(&[("permission", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = per_page {
        local_var_req_builder =
            local_var_req_builder.query(&[("per_page", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListCollaboratorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_contributors(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    anon: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Contributor>, Error<ReposSlashListContributorsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = anon {
        local_var_req_builder =
            local_var_req_builder.query(&[("anon", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = per_page {
        local_var_req_builder =
            local_var_req_builder.query(&[("per_page", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListContributorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_custom_deployment_rule_integrations(
    configuration: &configuration::Configuration,
    environment_name: &str,
    repo: &str,
    owner: &str,
    ...
    models::ReposListCustomDeploymentRuleIntegrations200Response,
    Error<ReposSlashListCustomDeploymentRuleIntegrationsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListCustomDeploymentRuleIntegrationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_list_deploy_keys(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::DeployKey>, Error<ReposSlashListDeployKeysError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListDeployKeysError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_deployment_branch_policies(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    environment_name: &str,
    ...
    models::ReposListDeploymentBranchPolicies200Response,
    Error<ReposSlashListDeploymentBranchPoliciesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListDeploymentBranchPoliciesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_deployment_statuses(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    deployment_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::DeploymentStatus>, Error<ReposSlashListDeploymentStatusesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListDeploymentStatusesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_deployments(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Deployment>, Error<ReposSlashListDeploymentsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = task {
        local_var_req_builder =
            local_var_req_builder.query(&[("task", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListDeploymentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_for_authenticated_user(
    configuration: &configuration::Configuration,
...
) -> Result<Vec<models::Repository>, Error<ReposSlashListForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    r#type: Option<&str>,
    sort: Option<&str>,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<ReposSlashListForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    r#type: Option<&str>,
    sort: Option<&str>,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<ReposSlashListForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_list_forks(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    sort: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<ReposSlashListForksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListForksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_invitations(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::RepositoryInvitation>, Error<ReposSlashListInvitationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListInvitationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_invitations_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    Vec<models::RepositoryInvitation>,
    Error<ReposSlashListInvitationsForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListInvitationsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_languages(
    ...
    owner: &str,
    repo: &str,
) -> Result<std::collections::HashMap<String, i32>, Error<ReposSlashListLanguagesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListLanguagesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_pages_builds(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::PageBuild>, Error<ReposSlashListPagesBuildsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListPagesBuildsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_public(
    configuration: &configuration::Configuration,
    since: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<ReposSlashListPublicError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListPublicError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_list_release_assets(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    release_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::ReleaseAsset>, Error<ReposSlashListReleaseAssetsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListReleaseAssetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_releases(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Release>, Error<ReposSlashListReleasesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListReleasesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_tag_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<Vec<models::TagProtection>, Error<ReposSlashListTagProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListTagProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_list_tags(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Tag>, Error<ReposSlashListTagsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListTagsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_teams(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Team>, Error<ReposSlashListTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_webhook_deliveries(
    ...
    per_page: Option<i32>,
    cursor: Option<&str>,
) -> Result<Vec<models::HookDeliveryItem>, Error<ReposSlashListWebhookDeliveriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListWebhookDeliveriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_list_webhooks(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Hook>, Error<ReposSlashListWebhooksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashListWebhooksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_merge(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_merge_request: models::ReposMergeRequest,
) -> Result<models::Commit, Error<ReposSlashMergeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashMergeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_merge_upstream(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_merge_upstream_request: models::ReposMergeUpstreamRequest,
) -> Result<models::MergedUpstream, Error<ReposSlashMergeUpstreamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashMergeUpstreamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_ping_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashPingWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_redeliver_webhook_delivery(
    ...
    hook_id: i32,
    delivery_id: i32,
) -> Result<serde_json::Value, Error<ReposSlashRedeliverWebhookDeliveryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRedeliverWebhookDeliveryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_remove_app_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_app_access_restrictions_request: models::ReposSetAppAccessRestrictionsRequest,
) -> Result<Vec<models::Integration>, Error<ReposSlashRemoveAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveAppAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_remove_collaborator(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveCollaboratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_remove_status_check_contexts(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_status_check_contexts_request: Option<models::ReposSetStatusCheckContextsRequest>,
) -> Result<Vec<String>, Error<ReposSlashRemoveStatusCheckContextsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveStatusCheckContextsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_remove_status_check_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<(), Error<ReposSlashRemoveStatusCheckProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveStatusCheckProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_remove_team_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_add_team_access_restrictions_request: Option<
        models::ReposAddTeamAccessRestrictionsRequest,
    >,
) -> Result<Vec<models::Team>, Error<ReposSlashRemoveTeamAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveTeamAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_remove_user_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_user_access_restrictions_request: models::ReposSetUserAccessRestrictionsRequest,
) -> Result<Vec<models::SimpleUser>, Error<ReposSlashRemoveUserAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRemoveUserAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_rename_branch(
    ...
    repo: &str,
    branch: &str,
    repos_rename_branch_request: models::ReposRenameBranchRequest,
) -> Result<models::BranchWithProtection, Error<ReposSlashRenameBranchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRenameBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_replace_all_topics(
    ...
    owner: &str,
    repo: &str,
    repos_replace_all_topics_request: models::ReposReplaceAllTopicsRequest,
) -> Result<models::Topic, Error<ReposSlashReplaceAllTopicsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashReplaceAllTopicsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_request_pages_build(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
) -> Result<models::PageBuildStatus, Error<ReposSlashRequestPagesBuildError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashRequestPagesBuildError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_set_admin_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
) -> Result<models::ProtectedBranchAdminEnforced, Error<ReposSlashSetAdminBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashSetAdminBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_set_app_access_restrictions(
    ...
    branch: &str,
    repos_set_app_access_restrictions_request: models::ReposSetAppAccessRestrictionsRequest,
) -> Result<Vec<models::Integration>, Error<ReposSlashSetAppAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashSetAppAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
pub async fn repos_slash_set_status_check_contexts(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_status_check_contexts_request: Option<models::ReposSetStatusCheckContextsRequest>,
) -> Result<Vec<String>, Error<ReposSlashSetStatusCheckContextsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashSetStatusCheckContextsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_set_team_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_team_access_restrictions_request: Option<
        models::ReposSetTeamAccessRestrictionsRequest,
    >,
) -> Result<Vec<models::Team>, Error<ReposSlashSetTeamAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashSetTeamAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_set_user_access_restrictions(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_set_user_access_restrictions_request: models::ReposSetUserAccessRestrictionsRequest,
) -> Result<Vec<models::SimpleUser>, Error<ReposSlashSetUserAccessRestrictionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashSetUserAccessRestrictionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_test_push_webhook(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashTestPushWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_transfer(
    ...
    owner: &str,
    repo: &str,
    repos_transfer_request: models::ReposTransferRequest,
) -> Result<models::MinimalRepository, Error<ReposSlashTransferError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashTransferError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update(
    ...
    owner: &str,
    repo: &str,
    repos_update_request: Option<models::ReposUpdateRequest>,
) -> Result<models::FullRepository, Error<ReposSlashUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_branch_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_update_branch_protection_request: models::ReposUpdateBranchProtectionRequest,
) -> Result<models::ProtectedBranch, Error<ReposSlashUpdateBranchProtectionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateBranchProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_commit_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    repos_update_commit_comment_request: models::ReposUpdateCommitCommentRequest,
) -> Result<models::CommitComment, Error<ReposSlashUpdateCommitCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateCommitCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_deployment_branch_policy(
    ...
    environment_name: &str,
    branch_policy_id: i32,
    deployment_branch_policy_name_pattern: models::DeploymentBranchPolicyNamePattern,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateDeploymentBranchPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Updates information for a GitHub Pages site. For more information, see \"[About GitHub Pages](/github/working-with-github-pages/about-github-pages).  The authenticated user must be a repository administrator, maintainer, or have the 'manage GitHub Pages settings' permission.  OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
pub async fn repos_slash_update_information_about_pages_site(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    repos_update_information_about_pages_site_request: Option<
        models::ReposUpdateInformationAboutPagesSiteRequest,
    >,
) -> Result<(), Error<ReposSlashUpdateInformationAboutPagesSiteError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_update_information_about_pages_site_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateInformationAboutPagesSiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn repos_slash_update_invitation(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    invitation_id: i32,
    repos_update_invitation_request: Option<models::ReposUpdateInvitationRequest>,
) -> Result<models::RepositoryInvitation, Error<ReposSlashUpdateInvitationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateInvitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_org_ruleset(
    configuration: &configuration::Configuration,
    org: &str,
    ruleset_id: i32,
    repos_update_org_ruleset_request: Option<models::ReposUpdateOrgRulesetRequest>,
) -> Result<models::RepositoryRuleset, Error<ReposSlashUpdateOrgRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateOrgRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_pull_request_review_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_update_pull_request_review_protection_request: Option<
        models::ReposUpdatePullRequestReviewProtectionRequest,
    >,
) -> Result<
    models::ProtectedBranchPullRequestReview,
    Error<ReposSlashUpdatePullRequestReviewProtectionError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_update_pull_request_review_protection_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdatePullRequestReviewProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_release(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    release_id: i32,
    repos_update_release_request: Option<models::ReposUpdateReleaseRequest>,
) -> Result<models::Release, Error<ReposSlashUpdateReleaseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateReleaseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_release_asset(
    ...
    repo: &str,
    asset_id: i32,
    repos_update_release_asset_request: Option<models::ReposUpdateReleaseAssetRequest>,
) -> Result<models::ReleaseAsset, Error<ReposSlashUpdateReleaseAssetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateReleaseAssetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_repo_ruleset(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    ruleset_id: i32,
    repos_update_repo_ruleset_request: Option<models::ReposUpdateRepoRulesetRequest>,
) -> Result<models::RepositoryRuleset, Error<ReposSlashUpdateRepoRulesetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateRepoRulesetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_status_check_protection(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    branch: &str,
    repos_update_status_check_protection_request: Option<
        models::ReposUpdateStatusCheckProtectionRequest,
    >,
) -> Result<models::StatusCheckPolicy, Error<ReposSlashUpdateStatusCheckProtectionError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_update_status_check_protection_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateStatusCheckProtectionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_webhook(
    ...
    repo: &str,
    hook_id: i32,
    repos_update_webhook_request: models::ReposUpdateWebhookRequest,
) -> Result<models::Hook, Error<ReposSlashUpdateWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_update_webhook_config_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    hook_id: i32,
    repos_update_webhook_config_for_repo_request: Option<
        models::ReposUpdateWebhookConfigForRepoRequest,
    >,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&repos_update_webhook_config_for_repo_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUpdateWebhookConfigForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn repos_slash_upload_release_asset(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    release_id: i32,
...
) -> Result<models::ReleaseAsset, Error<ReposSlashUploadReleaseAssetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReposSlashUploadReleaseAssetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
