...
pub async fn gists_slash_check_is_starred(
    ...
    let local_var_uri_str = format!(
        ...
        gist_id = crate::apis::urlencode(gist_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashCheckIsStarredError> =
...
pub async fn gists_slash_create(
    configuration: &configuration::Configuration,
    gists_create_request: models::GistsCreateRequest,
) -> Result<models::GistSimple, Error<GistsSlashCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_create_comment(
    configuration: &configuration::Configuration,
    gist_id: &str,
    gists_create_comment_request: models::GistsCreateCommentRequest,
) -> Result<models::GistComment, Error<GistsSlashCreateCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashCreateCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_delete(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_delete_comment(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashDeleteCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_fork(
    configuration: &configuration::Configuration,
    gist_id: &str,
) -> Result<models::BaseGist, Error<GistsSlashForkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashForkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_get(
    configuration: &configuration::Configuration,
    gist_id: &str,
) -> Result<models::GistSimple, Error<GistsSlashGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_get_comment(
    configuration: &configuration::Configuration,
    gist_id: &str,
    comment_id: i64,
) -> Result<models::GistComment, Error<GistsSlashGetCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashGetCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_get_revision(
    ...
    gist_id: &str,
    sha: &str,
) -> Result<models::GistSimple, Error<GistsSlashGetRevisionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashGetRevisionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_list(
    configuration: &configuration::Configuration,
    since: Option<String>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::BaseGist>, Error<GistsSlashListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_list_comments(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::GistComment>, Error<GistsSlashListCommentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListCommentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn gists_slash_list_commits(
    configuration: &configuration::Configuration,
    gist_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::GistCommit>, Error<GistsSlashListCommitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListCommitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_list_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    since: Option<String>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::BaseGist>, Error<GistsSlashListForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn gists_slash_list_forks(
    configuration: &configuration::Configuration,
    gist_id: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::GistSimple>, Error<GistsSlashListForksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListForksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_list_public(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::BaseGist>, Error<GistsSlashListPublicError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListPublicError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_list_starred(
    configuration: &configuration::Configuration,
    since: Option<String>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::BaseGist>, Error<GistsSlashListStarredError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashListStarredError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_star(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashStarError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
///
pub async fn gists_slash_unstar(
    configuration: &configuration::Configuration,
    gist_id: &str,
) -> Result<(), Error<GistsSlashUnstarError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashUnstarError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_update(
    configuration: &configuration::Configuration,
    gist_id: &str,
    gists_update_request: Option<models::GistsUpdateRequest>,
) -> Result<models::GistSimple, Error<GistsSlashUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn gists_slash_update_comment(
    configuration: &configuration::Configuration,
    gist_id: &str,
    comment_id: i64,
    gists_create_comment_request: models::GistsCreateCommentRequest,
) -> Result<models::GistComment, Error<GistsSlashUpdateCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GistsSlashUpdateCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
