...
pub async fn git_slash_create_blob(
    ...
    owner: &str,
    repo: &str,
    git_create_blob_request: models::GitCreateBlobRequest,
) -> Result<models::ShortBlob, Error<GitSlashCreateBlobError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashCreateBlobError> =
...
pub async fn git_slash_create_commit(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    git_create_commit_request: models::GitCreateCommitRequest,
) -> Result<models::GitCommit, Error<GitSlashCreateCommitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashCreateCommitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_create_ref(
    ...
    owner: &str,
    repo: &str,
    git_create_ref_request: models::GitCreateRefRequest,
) -> Result<models::GitRef, Error<GitSlashCreateRefError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashCreateRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_create_tag(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    git_create_tag_request: models::GitCreateTagRequest,
) -> Result<models::GitTag, Error<GitSlashCreateTagError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashCreateTagError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_create_tree(
    ...
    owner: &str,
    repo: &str,
    git_create_tree_request: models::GitCreateTreeRequest,
) -> Result<models::GitTree, Error<GitSlashCreateTreeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashCreateTreeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_delete_ref(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashDeleteRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_get_blob(
    ...
    repo: &str,
    file_sha: &str,
) -> Result<models::Blob, Error<GitSlashGetBlobError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        file_sha = crate::apis::urlencode(file_sha)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashGetBlobError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_get_commit(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    commit_sha: &str,
) -> Result<models::GitCommit, Error<GitSlashGetCommitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashGetCommitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_get_ref(
    ...
    repo: &str,
    r#ref: &str,
) -> Result<models::GitRef, Error<GitSlashGetRefError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashGetRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// **Signature verification object**  The response will include a `verification` object that describes the result of verifying the commit's signature. The following fields are included in the `verification` object:  | Name | Type | Description | | ---- | ---- | ----------- | | `verified` | `boolean` | Indicates whether GitHub considers the signature in this commit to be verified. | | `reason` | `string` | The reason for verified value. Possible values and their meanings are enumerated in table below. | | `signature` | `string` | The signature that was extracted from the commit. | | `payload` | `string` | The value that was signed. |  These are the possible values for `reason` in the `verification` object:  | Value | Description | | ----- | ----------- | | `expired_key` | The key that made the signature is expired. | | `not_signing_key` | The \"signing\" flag is not among the usage flags in the GPG key that made the signature. | | `gpgverify_error` | There was an error communicating with the signature verification service. | | `gpgverify_unavailable` | The signature verification service is currently unavailable. | | `unsigned` | The object does not include a signature. | | `unknown_signature_type` | A non-PGP signature was found in the commit. | | `no_user` | No user was associated with the `committer` email address in the commit. | | `unverified_email` | The `committer` email address in the commit was associated with a user, but the email address is not verified on their account. | | `bad_email` | The `committer` email address in the commit is not included in the identities of the PGP key that made the signature. | | `unknown_key` | The key that made the signature has not been registered with any user's account. | | `malformed_signature` | There was an error parsing the signature. | | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. | | `valid` | None of the above errors applied, so the signature is considered to be verified. |
pub async fn git_slash_get_tag(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    tag_sha: &str,
) -> Result<models::GitTag, Error<GitSlashGetTagError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        tag_sha = crate::apis::urlencode(tag_sha)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashGetTagError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_get_tree(
...
) -> Result<models::GitTree, Error<GitSlashGetTreeError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        owner = crate::apis::urlencode(owner),
        repo = crate::apis::urlencode(repo),
        tree_sha = crate::apis::urlencode(tree_sha)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashGetTreeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_list_matching_refs(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: &str,
) -> Result<Vec<models::GitRef>, Error<GitSlashListMatchingRefsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashListMatchingRefsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn git_slash_update_ref(
    ...
    repo: &str,
    r#ref: &str,
    git_update_ref_request: models::GitUpdateRefRequest,
) -> Result<models::GitRef, Error<GitSlashUpdateRefError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GitSlashUpdateRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
