...
pub async fn packages_slash_delete_package_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
) -> Result<(), Error<PackagesSlashDeletePackageForAuthenticatedUserError>> {
    ...
    let local_var_uri_str = format!(
        ...
        package_type = crate::apis::urlencode(package_type),
        package_name = crate::apis::urlencode(package_name)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageForAuthenticatedUserError> =
...
pub async fn packages_slash_delete_package_for_org(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
) -> Result<(), Error<PackagesSlashDeletePackageForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_delete_package_for_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_delete_package_version_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashDeletePackageVersionForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageVersionForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_delete_package_version_for_org(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashDeletePackageVersionForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageVersionForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_delete_package_version_for_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    username: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashDeletePackageVersionForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashDeletePackageVersionForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_all_package_versions_for_package_owned_by_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    page: Option<i32>,
    ...
    Vec<models::PackageVersion>,
    Error<PackagesSlashGetAllPackageVersionsForPackageOwnedByAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
...
pub async fn packages_slash_get_all_package_versions_for_package_owned_by_org(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
    ...
    Vec<models::PackageVersion>,
    Error<PackagesSlashGetAllPackageVersionsForPackageOwnedByOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetAllPackageVersionsForPackageOwnedByOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_all_package_versions_for_package_owned_by_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    username: &str,
    ...
    Vec<models::PackageVersion>,
    Error<PackagesSlashGetAllPackageVersionsForPackageOwnedByUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetAllPackageVersionsForPackageOwnedByUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
) -> Result<models::Package, Error<PackagesSlashGetPackageForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_for_organization(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
) -> Result<models::Package, Error<PackagesSlashGetPackageForOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageForOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_for_user(
    ...
    package_name: &str,
    username: &str,
) -> Result<models::Package, Error<PackagesSlashGetPackageForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_version_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    package_version_id: i32,
) -> Result<models::PackageVersion, Error<PackagesSlashGetPackageVersionForAuthenticatedUserError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageVersionForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_version_for_organization(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
    package_version_id: i32,
) -> Result<models::PackageVersion, Error<PackagesSlashGetPackageVersionForOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageVersionForOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_get_package_version_for_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    package_version_id: i32,
    username: &str,
) -> Result<models::PackageVersion, Error<PackagesSlashGetPackageVersionForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashGetPackageVersionForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_list_docker_migration_conflicting_packages_for_authenticated_user(
    configuration: &configuration::Configuration,
) -> Result<
    Vec<models::Package>,
    Error<PackagesSlashListDockerMigrationConflictingPackagesForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
...
pub async fn packages_slash_list_docker_migration_conflicting_packages_for_organization(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<
    Vec<models::Package>,
    Error<PackagesSlashListDockerMigrationConflictingPackagesForOrganizationError>,
> {
    let local_var_configuration = configuration;
...
pub async fn packages_slash_list_docker_migration_conflicting_packages_for_user(
    configuration: &configuration::Configuration,
    username: &str,
) -> Result<
    Vec<models::Package>,
    Error<PackagesSlashListDockerMigrationConflictingPackagesForUserError>,
> {
    let local_var_configuration = configuration;
...
pub async fn packages_slash_list_packages_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    visibility: Option<&str>,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Package>, Error<PackagesSlashListPackagesForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("package_type", &package_type.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashListPackagesForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_list_packages_for_organization(
    configuration: &configuration::Configuration,
    package_type: &str,
    org: &str,
    visibility: Option<&str>,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Package>, Error<PackagesSlashListPackagesForOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashListPackagesForOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_list_packages_for_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    username: &str,
    visibility: Option<&str>,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Package>, Error<PackagesSlashListPackagesForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashListPackagesForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    token: Option<&str>,
) -> Result<(), Error<PackagesSlashRestorePackageForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_for_org(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
    token: Option<&str>,
) -> Result<(), Error<PackagesSlashRestorePackageForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_for_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    username: &str,
    token: Option<&str>,
) -> Result<(), Error<PackagesSlashRestorePackageForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_version_for_authenticated_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashRestorePackageVersionForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageVersionForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_version_for_org(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    org: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashRestorePackageVersionForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageVersionForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn packages_slash_restore_package_version_for_user(
    configuration: &configuration::Configuration,
    package_type: &str,
    package_name: &str,
    username: &str,
    package_version_id: i32,
) -> Result<(), Error<PackagesSlashRestorePackageVersionForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PackagesSlashRestorePackageVersionForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
