...
pub async fn codespaces_slash_add_repository_for_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<CodespacesSlashAddRepositoryForSecretForAuthenticatedUserError>> {
...
pub async fn codespaces_slash_add_selected_repo_to_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<CodespacesSlashAddSelectedRepoToOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashAddSelectedRepoToOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_check_permissions_for_devcontainer(
    ...
    models::CodespacesPermissionsCheckForDevcontainer,
    Error<CodespacesSlashCheckPermissionsForDevcontainerError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("devcontainer_path", &devcontainer_path.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCheckPermissionsForDevcontainerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_codespace_machines_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<
    models::CodespacesRepoMachinesForAuthenticatedUser200Response,
    Error<CodespacesSlashCodespaceMachinesForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        codespace_name = crate::apis::urlencode(codespace_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCodespaceMachinesForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespaces_create_for_authenticated_user_request: models::CodespacesCreateForAuthenticatedUserRequest,
) -> Result<models::Codespace, Error<CodespacesSlashCreateForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_create_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_or_update_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    codespaces_create_or_update_org_secret_request: models::CodespacesCreateOrUpdateOrgSecretRequest,
) -> Result<serde_json::Value, Error<CodespacesSlashCreateOrUpdateOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_create_or_update_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateOrUpdateOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_or_update_repo_secret(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    secret_name: &str,
    codespaces_create_or_update_repo_secret_request: models::CodespacesCreateOrUpdateRepoSecretRequest,
) -> Result<serde_json::Value, Error<CodespacesSlashCreateOrUpdateRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_create_or_update_repo_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateOrUpdateRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_or_update_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
    codespaces_create_or_update_secret_for_authenticated_user_request: models::CodespacesCreateOrUpdateSecretForAuthenticatedUserRequest,
) -> Result<serde_json::Value, Error<CodespacesSlashCreateOrUpdateSecretForAuthenticatedUserError>>
{
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder
        .json(&codespaces_create_or_update_secret_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateOrUpdateSecretForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_with_pr_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    codespaces_create_with_pr_for_authenticated_user_request: Option<
        models::CodespacesCreateWithPrForAuthenticatedUserRequest,
    >,
) -> Result<models::Codespace, Error<CodespacesSlashCreateWithPrForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_create_with_pr_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateWithPrForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_create_with_repo_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    codespaces_create_with_repo_for_authenticated_user_request: Option<
        models::CodespacesCreateWithRepoForAuthenticatedUserRequest,
    >,
) -> Result<models::Codespace, Error<CodespacesSlashCreateWithRepoForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_create_with_repo_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashCreateWithRepoForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_codespaces_access_users(
    configuration: &configuration::Configuration,
    org: &str,
    codespaces_delete_codespaces_access_users_request: models::CodespacesDeleteCodespacesAccessUsersRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_delete_codespaces_access_users_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteCodespacesAccessUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<serde_json::Value, Error<CodespacesSlashDeleteForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_from_organization(
    ...
    username: &str,
    codespace_name: &str,
) -> Result<serde_json::Value, Error<CodespacesSlashDeleteFromOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteFromOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_org_secret(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_repo_secret(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_delete_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
) -> Result<(), Error<CodespacesSlashDeleteSecretForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashDeleteSecretForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_export_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<models::CodespaceExportDetails, Error<CodespacesSlashExportForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashExportForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_codespaces_for_user_in_org(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
    per_page: Option<i32>,
    ...
    models::CodespacesListInOrganization200Response,
    Error<CodespacesSlashGetCodespacesForUserInOrgError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetCodespacesForUserInOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_export_details_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
    export_id: &str,
) -> Result<
    models::CodespaceExportDetails,
    Error<CodespacesSlashGetExportDetailsForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        codespace_name = crate::apis::urlencode(codespace_name),
        export_id = crate::apis::urlencode(export_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetExportDetailsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<models::Codespace, Error<CodespacesSlashGetForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_org_public_key(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::CodespacesPublicKey, Error<CodespacesSlashGetOrgPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetOrgPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_org_secret(
    ...
    org: &str,
    secret_name: &str,
) -> Result<models::CodespacesOrgSecret, Error<CodespacesSlashGetOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_public_key_for_authenticated_user(
    configuration: &configuration::Configuration,
) -> Result<
    models::CodespacesUserPublicKey,
    Error<CodespacesSlashGetPublicKeyForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetPublicKeyForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_repo_public_key(
    ...
    owner: &str,
    repo: &str,
) -> Result<models::CodespacesPublicKey, Error<CodespacesSlashGetRepoPublicKeyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetRepoPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_repo_secret(
    ...
    repo: &str,
    secret_name: &str,
) -> Result<models::RepoCodespacesSecret, Error<CodespacesSlashGetRepoSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetRepoSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_get_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
) -> Result<models::CodespacesSecret, Error<CodespacesSlashGetSecretForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashGetSecretForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_devcontainers_in_repository_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::CodespacesListDevcontainersInRepositoryForAuthenticatedUser200Response,
...
pub async fn codespaces_slash_list_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    models::CodespacesListInOrganization200Response,
    Error<CodespacesSlashListForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = repository_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("repository_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_in_organization(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    models::CodespacesListInOrganization200Response,
    Error<CodespacesSlashListInOrganizationError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListInOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_in_repository_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    per_page: Option<i32>,
    ...
    models::CodespacesListInOrganization200Response,
    Error<CodespacesSlashListInRepositoryForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListInRepositoryForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_org_secrets(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::CodespacesListOrgSecrets200Response, Error<CodespacesSlashListOrgSecretsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListOrgSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_repo_secrets(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::CodespacesListRepoSecrets200Response, Error<CodespacesSlashListRepoSecretsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListRepoSecretsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_repositories_for_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
) -> Result<
    models::ActionsListSelectedReposForOrgSecret200Response,
    Error<CodespacesSlashListRepositoriesForSecretForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
...
pub async fn codespaces_slash_list_secrets_for_authenticated_user(
    configuration: &configuration::Configuration,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<
    models::CodespacesListSecretsForAuthenticatedUser200Response,
    Error<CodespacesSlashListSecretsForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListSecretsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_list_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    page: Option<i32>,
    ...
    models::ActionsListSelectedReposForOrgSecret200Response,
    Error<CodespacesSlashListSelectedReposForOrgSecretError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashListSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_pre_flight_with_repo_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: Option<&str>,
    ...
    models::CodespacesPreFlightWithRepoForAuthenticatedUser200Response,
    Error<CodespacesSlashPreFlightWithRepoForAuthenticatedUserError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = client_ip {
        local_var_req_builder =
            local_var_req_builder.query(&[("client_ip", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashPreFlightWithRepoForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_publish_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
    codespaces_publish_for_authenticated_user_request: models::CodespacesPublishForAuthenticatedUserRequest,
) -> Result<
    models::CodespaceWithFullRepository,
...
> {
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_publish_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashPublishForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_remove_repository_for_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<CodespacesSlashRemoveRepositoryForSecretForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
...
pub async fn codespaces_slash_remove_selected_repo_from_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    repository_id: i32,
) -> Result<(), Error<CodespacesSlashRemoveSelectedRepoFromOrgSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashRemoveSelectedRepoFromOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_repo_machines_for_authenticated_user(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    location: Option<&str>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashRepoMachinesForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_set_codespaces_access(
    configuration: &configuration::Configuration,
    org: &str,
    codespaces_set_codespaces_access_request: models::CodespacesSetCodespacesAccessRequest,
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashSetCodespacesAccessError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_set_codespaces_access_users(
    configuration: &configuration::Configuration,
    org: &str,
    codespaces_set_codespaces_access_users_request: models::CodespacesSetCodespacesAccessUsersRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_set_codespaces_access_users_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashSetCodespacesAccessUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_set_repositories_for_secret_for_authenticated_user(
    configuration: &configuration::Configuration,
    secret_name: &str,
    codespaces_set_repositories_for_secret_for_authenticated_user_request: models::CodespacesSetRepositoriesForSecretForAuthenticatedUserRequest,
) -> Result<(), Error<CodespacesSlashSetRepositoriesForSecretForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder
        .json(&codespaces_set_repositories_for_secret_for_authenticated_user_request);
...
pub async fn codespaces_slash_set_selected_repos_for_org_secret(
    configuration: &configuration::Configuration,
    org: &str,
    secret_name: &str,
    codespaces_set_selected_repos_for_org_secret_request: models::CodespacesSetSelectedReposForOrgSecretRequest,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_set_selected_repos_for_org_secret_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashSetSelectedReposForOrgSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_start_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<models::Codespace, Error<CodespacesSlashStartForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashStartForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_stop_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
) -> Result<models::Codespace, Error<CodespacesSlashStopForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashStopForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_stop_in_organization(
    ...
    username: &str,
    codespace_name: &str,
) -> Result<models::Codespace, Error<CodespacesSlashStopInOrganizationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashStopInOrganizationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn codespaces_slash_update_for_authenticated_user(
    configuration: &configuration::Configuration,
    codespace_name: &str,
    codespaces_update_for_authenticated_user_request: Option<
        models::CodespacesUpdateForAuthenticatedUserRequest,
    >,
    ...
    local_var_req_builder =
        local_var_req_builder.json(&codespaces_update_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CodespacesSlashUpdateForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
