...
pub async fn oidc_slash_get_oidc_custom_sub_template_for_org(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::OidcCustomSub, Error<OidcSlashGetOidcCustomSubTemplateForOrgError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OidcSlashGetOidcCustomSubTemplateForOrgError> =
...
pub async fn oidc_slash_update_oidc_custom_sub_template_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    oidc_custom_sub: models::OidcCustomSub,
) -> Result<serde_json::Value, Error<OidcSlashUpdateOidcCustomSubTemplateForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OidcSlashUpdateOidcCustomSubTemplateForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
