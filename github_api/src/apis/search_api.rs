...
pub async fn search_slash_code(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchCode200Response, Error<SearchSlashCodeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashCodeError> =
...
pub async fn search_slash_commits(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchCommits200Response, Error<SearchSlashCommitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashCommitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_issues_and_pull_requests(
    ...
    models::SearchIssuesAndPullRequests200Response,
    Error<SearchSlashIssuesAndPullRequestsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashIssuesAndPullRequestsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_labels(
    configuration: &configuration::Configuration,
    repository_id: i32,
    q: &str,
    sort: Option<&str>,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchLabels200Response, Error<SearchSlashLabelsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("repository_id", &repository_id.to_string())]);
    local_var_req_builder = local_var_req_builder.query(&[("q", &q.to_string())]);
    if let Some(ref local_var_str) = sort {
        local_var_req_builder =
            local_var_req_builder.query(&[("sort", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_repos(
    configuration: &configuration::Configuration,
    q: &str,
    sort: Option<&str>,
    order: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchRepos200Response, Error<SearchSlashReposError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashReposError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_topics(
    configuration: &configuration::Configuration,
    q: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchTopics200Response, Error<SearchSlashTopicsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashTopicsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_slash_users(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::SearchUsers200Response, Error<SearchSlashUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchSlashUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
