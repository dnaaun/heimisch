...
pub async fn pulls_slash_check_if_merged(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashCheckIfMergedError> =
...
pub async fn pulls_slash_create(
    ...
    owner: &str,
    repo: &str,
    pulls_create_request: models::PullsCreateRequest,
...
pub async fn pulls_slash_create_reply_for_review_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    comment_id: i64,
    pulls_create_reply_for_review_comment_request: models::PullsCreateReplyForReviewCommentRequest,
) -> Result<models::PullRequestReviewComment, Error<PullsSlashCreateReplyForReviewCommentError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&pulls_create_reply_for_review_comment_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashCreateReplyForReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_create_review(
    ...
    repo: &str,
    pull_number: i32,
    pulls_create_review_request: Option<models::PullsCreateReviewRequest>,
) -> Result<models::PullRequestReview, Error<PullsSlashCreateReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashCreateReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_create_review_comment(
    ...
    repo: &str,
    pull_number: i32,
    pulls_create_review_comment_request: models::PullsCreateReviewCommentRequest,
) -> Result<models::PullRequestReviewComment, Error<PullsSlashCreateReviewCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashCreateReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_delete_pending_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    review_id: i32,
) -> Result<models::PullRequestReview, Error<PullsSlashDeletePendingReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashDeletePendingReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_delete_review_comment(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashDeleteReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_dismiss_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    review_id: i32,
    pulls_dismiss_review_request: models::PullsDismissReviewRequest,
) -> Result<models::PullRequestReview, Error<PullsSlashDismissReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashDismissReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_get_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    review_id: i32,
) -> Result<models::PullRequestReview, Error<PullsSlashGetReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashGetReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_get_review_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
) -> Result<models::PullRequestReviewComment, Error<PullsSlashGetReviewCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashGetReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_comments_for_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::ReviewComment>, Error<PullsSlashListCommentsForReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListCommentsForReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_commits(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Commit>, Error<PullsSlashListCommitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListCommitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_files(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::DiffEntry>, Error<PullsSlashListFilesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListFilesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_requested_reviewers(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
) -> Result<models::PullRequestReviewRequest, Error<PullsSlashListRequestedReviewersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListRequestedReviewersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_review_comments(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::PullRequestReviewComment>, Error<PullsSlashListReviewCommentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListReviewCommentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_review_comments_for_repo(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    sort: Option<&str>,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::PullRequestReviewComment>, Error<PullsSlashListReviewCommentsForRepoError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListReviewCommentsForRepoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_list_reviews(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::PullRequestReview>, Error<PullsSlashListReviewsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashListReviewsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_merge(
    ...
    repo: &str,
    pull_number: i32,
    pulls_merge_request: Option<models::PullsMergeRequest>,
) -> Result<models::PullRequestMergeResult, Error<PullsSlashMergeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashMergeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_remove_requested_reviewers(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    pulls_remove_requested_reviewers_request: models::PullsRemoveRequestedReviewersRequest,
) -> Result<models::PullRequestSimple, Error<PullsSlashRemoveRequestedReviewersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashRemoveRequestedReviewersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_request_reviewers(
    ...
    repo: &str,
    pull_number: i32,
    pulls_request_reviewers_request: Option<models::PullsRequestReviewersRequest>,
) -> Result<models::PullRequestSimple, Error<PullsSlashRequestReviewersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashRequestReviewersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_submit_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    review_id: i32,
    pulls_submit_review_request: models::PullsSubmitReviewRequest,
) -> Result<models::PullRequestReview, Error<PullsSlashSubmitReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashSubmitReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_update(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    pulls_update_request: Option<models::PullsUpdateRequest>,
) -> Result<models::PullRequest, Error<PullsSlashUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_update_branch(
    ...
    repo: &str,
    pull_number: i32,
    pulls_update_branch_request: Option<models::PullsUpdateBranchRequest>,
) -> Result<
    models::ActivityMarkRepoNotificationsAsRead202Response,
    Error<PullsSlashUpdateBranchError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashUpdateBranchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_update_review(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    pull_number: i32,
    review_id: i32,
    pulls_update_review_request: models::PullsUpdateReviewRequest,
) -> Result<models::PullRequestReview, Error<PullsSlashUpdateReviewError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashUpdateReviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pulls_slash_update_review_comment(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    comment_id: i64,
    pulls_update_review_comment_request: models::PullsUpdateReviewCommentRequest,
) -> Result<models::PullRequestReviewComment, Error<PullsSlashUpdateReviewCommentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PullsSlashUpdateReviewCommentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
