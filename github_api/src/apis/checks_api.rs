...
pub async fn checks_slash_create(
    ...
    owner: &str,
    repo: &str,
    checks_create_request: models::ChecksCreateRequest,
) -> Result<models::CheckRun, Error<ChecksSlashCreateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashCreateError> =
...
pub async fn checks_slash_create_suite(
    ...
    owner: &str,
    repo: &str,
    checks_create_suite_request: models::ChecksCreateSuiteRequest,
) -> Result<models::CheckSuite, Error<ChecksSlashCreateSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashCreateSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_get(
    ...
    repo: &str,
    check_run_id: i32,
) -> Result<models::CheckRun, Error<ChecksSlashGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_get_suite(
    ...
    repo: &str,
    check_suite_id: i32,
) -> Result<models::CheckSuite, Error<ChecksSlashGetSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashGetSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_list_annotations(
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::CheckAnnotation>, Error<ChecksSlashListAnnotationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashListAnnotationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_list_for_ref(
    ...
    page: Option<i32>,
    app_id: Option<i32>,
) -> Result<models::ChecksListForSuite200Response, Error<ChecksSlashListForRefError>> {
    let local_var_configuration = configuration;
...
pub async fn checks_slash_list_for_suite(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    check_suite_id: i32,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ChecksListForSuite200Response, Error<ChecksSlashListForSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashListForSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_list_suites_for_ref(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    r#ref: &str,
    ...
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::ChecksListSuitesForRef200Response, Error<ChecksSlashListSuitesForRefError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashListSuitesForRefError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_rerequest_run(
    ...
    repo: &str,
    check_run_id: i32,
) -> Result<serde_json::Value, Error<ChecksSlashRerequestRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashRerequestRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_rerequest_suite(
    ...
    repo: &str,
    check_suite_id: i32,
) -> Result<serde_json::Value, Error<ChecksSlashRerequestSuiteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashRerequestSuiteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_set_suites_preferences(
    configuration: &configuration::Configuration,
    owner: &str,
    repo: &str,
    checks_set_suites_preferences_request: models::ChecksSetSuitesPreferencesRequest,
) -> Result<models::CheckSuitePreference, Error<ChecksSlashSetSuitesPreferencesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashSetSuitesPreferencesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn checks_slash_update(
    ...
    repo: &str,
    check_run_id: i32,
    checks_update_request: models::ChecksUpdateRequest,
) -> Result<models::CheckRun, Error<ChecksSlashUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChecksSlashUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
