...
pub async fn api_insights_slash_get_route_stats_by_actor(
...
) -> Result<Vec<models::ApiInsightsRouteStatsInner>, Error<ApiInsightsSlashGetRouteStatsByActorError>>
{
    ...
    let local_var_uri_str = format!(
        ...
        actor_type = crate::apis::urlencode(actor_type),
        actor_id = actor_id
    );
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("min_timestamp", &min_timestamp.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("max_timestamp", &max_timestamp.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetRouteStatsByActorError> =
...
pub async fn api_insights_slash_get_subject_stats(
    configuration: &configuration::Configuration,
    org: &str,
    min_timestamp: &str,
    max_timestamp: &str,
    ...
    direction: Option<&str>,
    sort: Option<Vec<String>>,
) -> Result<Vec<models::ApiInsightsSubjectStatsInner>, Error<ApiInsightsSlashGetSubjectStatsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetSubjectStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_summary_stats(
    configuration: &configuration::Configuration,
    org: &str,
    min_timestamp: &str,
    max_timestamp: &str,
) -> Result<models::ApiInsightsSummaryStats, Error<ApiInsightsSlashGetSummaryStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetSummaryStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_summary_stats_by_actor(
    configuration: &configuration::Configuration,
    org: &str,
    min_timestamp: &str,
    max_timestamp: &str,
    actor_type: &str,
    actor_id: i32,
) -> Result<models::ApiInsightsSummaryStats, Error<ApiInsightsSlashGetSummaryStatsByActorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetSummaryStatsByActorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_summary_stats_by_user(
    configuration: &configuration::Configuration,
    org: &str,
    user_id: &str,
    min_timestamp: &str,
    max_timestamp: &str,
) -> Result<models::ApiInsightsSummaryStats, Error<ApiInsightsSlashGetSummaryStatsByUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetSummaryStatsByUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_time_stats(
    configuration: &configuration::Configuration,
    org: &str,
    min_timestamp: &str,
    max_timestamp: &str,
    timestamp_increment: &str,
) -> Result<Vec<models::ApiInsightsTimeStatsInner>, Error<ApiInsightsSlashGetTimeStatsError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("max_timestamp", &max_timestamp.to_string())]);
    local_var_req_builder =
        local_var_req_builder.query(&[("timestamp_increment", &timestamp_increment.to_string())]);
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetTimeStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_time_stats_by_actor(
    configuration: &configuration::Configuration,
    org: &str,
    actor_type: &str,
    actor_id: i32,
    ...
    max_timestamp: &str,
    timestamp_increment: &str,
) -> Result<Vec<models::ApiInsightsTimeStatsInner>, Error<ApiInsightsSlashGetTimeStatsByActorError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetTimeStatsByActorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_time_stats_by_user(
    configuration: &configuration::Configuration,
    org: &str,
    user_id: &str,
    min_timestamp: &str,
    max_timestamp: &str,
    timestamp_increment: &str,
) -> Result<Vec<models::ApiInsightsTimeStatsInner>, Error<ApiInsightsSlashGetTimeStatsByUserError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetTimeStatsByUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn api_insights_slash_get_user_stats(
    configuration: &configuration::Configuration,
    org: &str,
    user_id: &str,
    min_timestamp: &str,
    ...
    direction: Option<&str>,
    sort: Option<Vec<String>>,
) -> Result<Vec<models::ApiInsightsUserStatsInner>, Error<ApiInsightsSlashGetUserStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiInsightsSlashGetUserStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_add_security_manager_team(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
) -> Result<(), Error<OrgsSlashAddSecurityManagerTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashAddSecurityManagerTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_assign_team_to_org_role(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    role_id: i32,
) -> Result<(), Error<OrgsSlashAssignTeamToOrgRoleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashAssignTeamToOrgRoleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_assign_user_to_org_role(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
    role_id: i32,
) -> Result<(), Error<OrgsSlashAssignUserToOrgRoleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashAssignUserToOrgRoleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_block_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashBlockUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_cancel_invitation(
    configuration: &configuration::Configuration,
    org: &str,
    invitation_id: i32,
) -> Result<(), Error<OrgsSlashCancelInvitationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCancelInvitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_check_blocked_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCheckBlockedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_check_membership_for_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashCheckMembershipForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCheckMembershipForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_check_public_membership_for_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashCheckPublicMembershipForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCheckPublicMembershipForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_convert_member_to_outside_collaborator(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
    orgs_convert_member_to_outside_collaborator_request: Option<
        models::OrgsConvertMemberToOutsideCollaboratorRequest,
    >,
) -> Result<serde_json::Value, Error<OrgsSlashConvertMemberToOutsideCollaboratorError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&orgs_convert_member_to_outside_collaborator_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashConvertMemberToOutsideCollaboratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_create_invitation(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_create_invitation_request: Option<models::OrgsCreateInvitationRequest>,
) -> Result<models::OrganizationInvitation, Error<OrgsSlashCreateInvitationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCreateInvitationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_create_or_update_custom_properties(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_create_or_update_custom_properties_request: models::OrgsCreateOrUpdateCustomPropertiesRequest,
) -> Result<Vec<models::CustomProperty>, Error<OrgsSlashCreateOrUpdateCustomPropertiesError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&orgs_create_or_update_custom_properties_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCreateOrUpdateCustomPropertiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_create_or_update_custom_properties_values_for_repos(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_create_or_update_custom_properties_values_for_repos_request: models::OrgsCreateOrUpdateCustomPropertiesValuesForReposRequest,
) -> Result<(), Error<OrgsSlashCreateOrUpdateCustomPropertiesValuesForReposError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder
        .json(&orgs_create_or_update_custom_properties_values_for_repos_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCreateOrUpdateCustomPropertiesValuesForReposError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_create_or_update_custom_property(
    configuration: &configuration::Configuration,
    org: &str,
    custom_property_name: &str,
    orgs_create_or_update_custom_property_request: models::OrgsCreateOrUpdateCustomPropertyRequest,
) -> Result<models::CustomProperty, Error<OrgsSlashCreateOrUpdateCustomPropertyError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        org = crate::apis::urlencode(org),
        custom_property_name = crate::apis::urlencode(custom_property_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    local_var_req_builder =
        local_var_req_builder.json(&orgs_create_or_update_custom_property_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCreateOrUpdateCustomPropertyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_create_webhook(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_create_webhook_request: models::OrgsCreateWebhookRequest,
) -> Result<models::OrgHook, Error<OrgsSlashCreateWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashCreateWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_delete(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<serde_json::Value, Error<OrgsSlashDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_delete_webhook(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
) -> Result<(), Error<OrgsSlashDeleteWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashDeleteWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_enable_or_disable_security_product_on_all_org_repos(
    configuration: &configuration::Configuration,
    org: &str,
    security_product: &str,
    enablement: &str,
    orgs_enable_or_disable_security_product_on_all_org_repos_request: Option<
        models::OrgsEnableOrDisableSecurityProductOnAllOrgReposRequest,
    >,
) -> Result<(), Error<OrgsSlashEnableOrDisableSecurityProductOnAllOrgReposError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        org = crate::apis::urlencode(org),
        security_product = crate::apis::urlencode(security_product),
        enablement = crate::apis::urlencode(enablement)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder
        .json(&orgs_enable_or_disable_security_product_on_all_org_repos_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashEnableOrDisableSecurityProductOnAllOrgReposError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_all_custom_properties(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<Vec<models::CustomProperty>, Error<OrgsSlashGetAllCustomPropertiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetAllCustomPropertiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_custom_property(
    configuration: &configuration::Configuration,
    org: &str,
    custom_property_name: &str,
) -> Result<models::CustomProperty, Error<OrgsSlashGetCustomPropertyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetCustomPropertyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_membership_for_authenticated_user(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::OrgMembership, Error<OrgsSlashGetMembershipForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetMembershipForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_membership_for_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<models::OrgMembership, Error<OrgsSlashGetMembershipForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetMembershipForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_org_role(
    configuration: &configuration::Configuration,
    org: &str,
    role_id: i32,
) -> Result<models::OrganizationRole, Error<OrgsSlashGetOrgRoleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetOrgRoleError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_webhook(
    ...
    org: &str,
    hook_id: i32,
) -> Result<models::OrgHook, Error<OrgsSlashGetWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_webhook_config_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
) -> Result<models::WebhookConfig, Error<OrgsSlashGetWebhookConfigForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetWebhookConfigForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_get_webhook_delivery(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
    delivery_id: i32,
) -> Result<models::HookDelivery, Error<OrgsSlashGetWebhookDeliveryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashGetWebhookDeliveryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list(
    ...
    since: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::OrganizationSimple>, Error<OrgsSlashListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_app_installations(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<models::OrgsListAppInstallations200Response, Error<OrgsSlashListAppInstallationsError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListAppInstallationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_attestations(
    configuration: &configuration::Configuration,
    org: &str,
    subject_digest: &str,
    per_page: Option<i32>,
    before: Option<&str>,
    after: Option<&str>,
) -> Result<models::OrgsListAttestations200Response, Error<OrgsSlashListAttestationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListAttestationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_blocked_users(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<OrgsSlashListBlockedUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListBlockedUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_custom_properties_values_for_repos(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    Vec<models::OrgRepoCustomPropertyValues>,
    Error<OrgsSlashListCustomPropertiesValuesForReposError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = repository_query {
        local_var_req_builder =
            local_var_req_builder.query(&[("repository_query", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListCustomPropertiesValuesForReposError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_failed_invitations(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrganizationInvitation>, Error<OrgsSlashListFailedInvitationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListFailedInvitationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_for_user(
    configuration: &configuration::Configuration,
    username: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrganizationSimple>, Error<OrgsSlashListForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_invitation_teams(
    configuration: &configuration::Configuration,
    org: &str,
    invitation_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::Team>, Error<OrgsSlashListInvitationTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListInvitationTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_memberships_for_authenticated_user(
    configuration: &configuration::Configuration,
    state: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrgMembership>, Error<OrgsSlashListMembershipsForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListMembershipsForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_org_role_teams(
    configuration: &configuration::Configuration,
    org: &str,
    role_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::TeamRoleAssignment>, Error<OrgsSlashListOrgRoleTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListOrgRoleTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_org_role_users(
    configuration: &configuration::Configuration,
    org: &str,
    role_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::UserRoleAssignment>, Error<OrgsSlashListOrgRoleUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListOrgRoleUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_org_roles(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<models::OrgsListOrgRoles200Response, Error<OrgsSlashListOrgRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListOrgRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_outside_collaborators(
    configuration: &configuration::Configuration,
    org: &str,
    filter: Option<&str>,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<OrgsSlashListOutsideCollaboratorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListOutsideCollaboratorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_pat_grant_repositories(
    configuration: &configuration::Configuration,
    org: &str,
    pat_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<OrgsSlashListPatGrantRepositoriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPatGrantRepositoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_pat_grant_request_repositories(
    configuration: &configuration::Configuration,
    org: &str,
    pat_request_id: i32,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::MinimalRepository>, Error<OrgsSlashListPatGrantRequestRepositoriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPatGrantRequestRepositoriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_pat_grant_requests(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    last_used_before: Option<String>,
    last_used_after: Option<String>,
) -> Result<
    Vec<models::OrganizationProgrammaticAccessGrantRequest>,
    Error<OrgsSlashListPatGrantRequestsError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = repository {
        local_var_req_builder =
            local_var_req_builder.query(&[("repository", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = last_used_before {
        local_var_req_builder =
            local_var_req_builder.query(&[("last_used_before", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = last_used_after {
        local_var_req_builder =
            local_var_req_builder.query(&[("last_used_after", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPatGrantRequestsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_pat_grants(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    ...
    last_used_before: Option<String>,
    last_used_after: Option<String>,
) -> Result<Vec<models::OrganizationProgrammaticAccessGrant>, Error<OrgsSlashListPatGrantsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPatGrantsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_pending_invitations(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
    role: Option<&str>,
    invitation_source: Option<&str>,
) -> Result<Vec<models::OrganizationInvitation>, Error<OrgsSlashListPendingInvitationsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = invitation_source {
        local_var_req_builder =
            local_var_req_builder.query(&[("invitation_source", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPendingInvitationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_public_members(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::SimpleUser>, Error<OrgsSlashListPublicMembersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListPublicMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_security_manager_teams(
    configuration: &configuration::Configuration,
    org: &str,
) -> Result<Vec<models::TeamSimple>, Error<OrgsSlashListSecurityManagerTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListSecurityManagerTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_list_webhook_deliveries(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
    per_page: Option<i32>,
    cursor: Option<&str>,
) -> Result<Vec<models::HookDeliveryItem>, Error<OrgsSlashListWebhookDeliveriesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListWebhookDeliveriesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// You must be an organization owner to use this endpoint.  OAuth app tokens and personal access tokens (classic) need `admin:org_hook` scope. OAuth apps cannot list, view, or edit webhooks that they did not create and users cannot list, view, or edit webhooks that were created by OAuth apps.
pub async fn orgs_slash_list_webhooks(
    configuration: &configuration::Configuration,
    org: &str,
    per_page: Option<i32>,
    page: Option<i32>,
) -> Result<Vec<models::OrgHook>, Error<OrgsSlashListWebhooksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashListWebhooksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_ping_webhook(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
) -> Result<(), Error<OrgsSlashPingWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashPingWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_redeliver_webhook_delivery(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
    delivery_id: i32,
) -> Result<serde_json::Value, Error<OrgsSlashRedeliverWebhookDeliveryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRedeliverWebhookDeliveryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_custom_property(
    ...
    org: &str,
    custom_property_name: &str,
) -> Result<(), Error<OrgsSlashRemoveCustomPropertyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemoveCustomPropertyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_member(
    ...
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashRemoveMemberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemoveMemberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_membership_for_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashRemoveMembershipForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemoveMembershipForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_outside_collaborator(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashRemoveOutsideCollaboratorError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemoveOutsideCollaboratorError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_public_membership_for_authenticated_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashRemovePublicMembershipForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemovePublicMembershipForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_remove_security_manager_team(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
) -> Result<(), Error<OrgsSlashRemoveSecurityManagerTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRemoveSecurityManagerTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_review_pat_grant_request(
    configuration: &configuration::Configuration,
    org: &str,
    pat_request_id: i32,
    orgs_review_pat_grant_request_request: models::OrgsReviewPatGrantRequestRequest,
) -> Result<(), Error<OrgsSlashReviewPatGrantRequestError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashReviewPatGrantRequestError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_review_pat_grant_requests_in_bulk(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_review_pat_grant_requests_in_bulk_request: models::OrgsReviewPatGrantRequestsInBulkRequest,
) -> Result<serde_json::Value, Error<OrgsSlashReviewPatGrantRequestsInBulkError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&orgs_review_pat_grant_requests_in_bulk_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashReviewPatGrantRequestsInBulkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_revoke_all_org_roles_team(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
) -> Result<(), Error<OrgsSlashRevokeAllOrgRolesTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRevokeAllOrgRolesTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_revoke_all_org_roles_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashRevokeAllOrgRolesUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRevokeAllOrgRolesUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_revoke_org_role_team(
    configuration: &configuration::Configuration,
    org: &str,
    team_slug: &str,
    role_id: i32,
) -> Result<(), Error<OrgsSlashRevokeOrgRoleTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRevokeOrgRoleTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_revoke_org_role_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
    role_id: i32,
) -> Result<(), Error<OrgsSlashRevokeOrgRoleUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashRevokeOrgRoleUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_set_membership_for_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
    orgs_set_membership_for_user_request: Option<models::OrgsSetMembershipForUserRequest>,
) -> Result<models::OrgMembership, Error<OrgsSlashSetMembershipForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashSetMembershipForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_set_public_membership_for_authenticated_user(
    configuration: &configuration::Configuration,
    org: &str,
    username: &str,
) -> Result<(), Error<OrgsSlashSetPublicMembershipForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashSetPublicMembershipForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_unblock_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUnblockUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_update_request: Option<models::OrgsUpdateRequest>,
) -> Result<models::OrganizationFull, Error<OrgsSlashUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update_membership_for_authenticated_user(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_update_membership_for_authenticated_user_request: models::OrgsUpdateMembershipForAuthenticatedUserRequest,
) -> Result<models::OrgMembership, Error<OrgsSlashUpdateMembershipForAuthenticatedUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&orgs_update_membership_for_authenticated_user_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdateMembershipForAuthenticatedUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update_pat_access(
    ...
    org: &str,
    pat_id: i32,
    orgs_update_pat_access_request: models::OrgsUpdatePatAccessRequest,
) -> Result<(), Error<OrgsSlashUpdatePatAccessError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdatePatAccessError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update_pat_accesses(
    configuration: &configuration::Configuration,
    org: &str,
    orgs_update_pat_accesses_request: models::OrgsUpdatePatAccessesRequest,
) -> Result<serde_json::Value, Error<OrgsSlashUpdatePatAccessesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdatePatAccessesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update_webhook(
    ...
    org: &str,
    hook_id: i32,
    orgs_update_webhook_request: Option<models::OrgsUpdateWebhookRequest>,
) -> Result<models::OrgHook, Error<OrgsSlashUpdateWebhookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdateWebhookError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn orgs_slash_update_webhook_config_for_org(
    configuration: &configuration::Configuration,
    org: &str,
    hook_id: i32,
    apps_update_webhook_config_for_app_request: Option<
        models::AppsUpdateWebhookConfigForAppRequest,
    >,
) -> Result<models::WebhookConfig, Error<OrgsSlashUpdateWebhookConfigForOrgError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OrgsSlashUpdateWebhookConfigForOrgError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
