...
use super::{
    not_found::NotFound,
    repository::{
        issues_tab::new_issue::NewIssue, pull_requests_tab::PullRequestsTab, RepositoryPageContext,
    },
};
...
impl RouteToView for ::leptos::prelude::Memo<RootOwnerNameRepoName> {
    ...
    type ArgFromParent = RepositoryPageContext;
    fn render(
        self,
        arg_from_parent: Self::ArgFromParent,
        prev_params: Self::PrevParams,
...
pub enum RootOwnerNameRepoNameIssues {
    New(RootOwnerNameRepoNameIssuesNew),
    IssueNumber {
        issue_number: String,
...
impl std::fmt::Display for RootOwnerNameRepoNameIssues {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::New(child) => write!(f, "/new{}", child),
            Self::Empty => write!(f, "/"),
            Self::IssueNumber {
                issue_number,
                child,
...
impl RootOwnerNameRepoNameIssues {
    fn get_only(&self) -> RootOwnerNameRepoNameIssuesOnly {
        match self {
            Self::New(..) => RootOwnerNameRepoNameIssuesOnly::New,
...
impl RouteToView for ::leptos::prelude::Memo<RootOwnerNameRepoNameIssues> {
    ...
    fn render(
        ...
        let child_memo_new =
            ::leptos::prelude::Memo::new(move |_| match ::leptos::prelude::Get::get(&self) {
                RootOwnerNameRepoNameIssues::New(child) => Some(child),
                _ => None,
            });
        ...
        move || {
            let _ = ::leptos::prelude::Get::get(&this_part_only);
            match *::leptos::prelude::ReadUntracked::read_untracked(&self) {
                RootOwnerNameRepoNameIssues::New(_) => {
                    let child_memo = ::zwang_router::MemoExt::unwrap(child_memo_new);
                    let outlet: ::std::sync::Arc<
                        dyn core::ops::Fn(_) -> _ + ::core::marker::Send + ::core::marker::Sync,
                    > = ::std::sync::Arc::new(move |arg_from_parent| {
                        child_memo.render(arg_from_parent, prev_params)
...
#[derive(Debug, PartialEq, Eq, Clone)]
pub enum RootOwnerNameRepoNameIssuesNew {
    Empty,
}
impl<'a> TryFrom<::zwang_router::Slashed<'a>> for RootOwnerNameRepoNameIssuesNew {
    type Error = String;
    fn try_from(value: ::zwang_router::Slashed<'a>) -> std::result::Result<Self, Self::Error> {
        let (head, tail) = ::zwang_router::split_slashed(value);
        match head.non_slash() {
...
impl std::fmt::Display for RootOwnerNameRepoNameIssuesNew {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Empty => write!(f, "/"),
        }
...
#[derive(Debug, PartialEq, Eq, Clone, Copy)]
enum RootOwnerNameRepoNameIssuesNewOnly {
    Empty,
}
impl RootOwnerNameRepoNameIssuesNew {
    fn get_only(&self) -> RootOwnerNameRepoNameIssuesNewOnly {
        match self {
            Self::Empty => RootOwnerNameRepoNameIssuesNewOnly::Empty,
        }
    }
}
impl RouteToView for ::leptos::prelude::Memo<RootOwnerNameRepoNameIssuesNew> {
    type PrevParams = ParamsOwnerNameRepoName;
    type ArgFromParent = RepositoryPageContext;
    fn render(
        self,
